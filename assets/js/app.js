...
const TEMPLATE_I18N={
  en:{frayerTitle:'Frayer Model',definition:'Definition',characteristics:'Characteristics',examples:'Examples',nonExamples:'Non-Examples',kwlKnow:'Know',kwlWant:'Want to Know',kwlLearned:'Learned',sideA:'Side A',sideB:'Side B',caption:'Caption',both:'Both',mainIdea:'Main Idea',idea:'Idea',event:'Event',comicTitle:'My Comic',comicLine:'Say something!',certTitle:'Certificate of Achievement',certPresented:'This certificate is proudly presented to',certName:'Student Name',certFor:'for outstanding work',certDate:'Date',certSignature:'Signature'},
  es:{frayerTitle:'Modelo Frayer',definition:'Definición',characteristics:'Características',examples:'Ejemplos',nonExamples:'No ejemplos',kwlKnow:'Sé',kwlWant:'Quiero saber',kwlLearned:'Aprendí',sideA:'Lado A',sideB:'Lado B',caption:'Subtítulo',both:'Ambos',mainIdea:'Idea principal',idea:'Idea',event:'Evento',comicTitle:'Mi cómic',comicLine:'¡Di algo!',certTitle:'Certificado de logro',certPresented:'Este certificado se otorga con orgullo a',certName:'Nombre del estudiante',certFor:'por un trabajo sobresaliente',certDate:'Fecha',certSignature:'Firma'},
  vi:{frayerTitle:'Mô hình Frayer',definition:'Định nghĩa',characteristics:'Đặc điểm',examples:'Ví dụ',nonExamples:'Không phải ví dụ',kwlKnow:'Đã biết',kwlWant:'Muốn biết',kwlLearned:'Đã học',sideA:'Bên A',sideB:'Bên B',caption:'Chú thích',both:'Cả hai',mainIdea:'Ý chính',idea:'Ý tưởng',event:'Sự kiện',comicTitle:'Truyện tranh của tôi',comicLine:'Nói gì đó đi!',certTitle:'Giấy chứng nhận thành tích',certPresented:'Giấy chứng nhận này trân trọng trao cho',certName:'Tên học sinh',certFor:'vì thành tích xuất sắc',certDate:'Ngày',certSignature:'Chữ ký'},
  ar:{frayerTitle:'نموذج فراير',definition:'تعريف',characteristics:'خصائص',examples:'أمثلة',nonExamples:'أمثلة غير صحيحة',kwlKnow:'أعرف',kwlWant:'أريد أن أعرف',kwlLearned:'تعلمت',sideA:'الجانب أ',sideB:'الجانب ب',caption:'تعليق',both:'كلاهما',mainIdea:'الفكرة الرئيسة',idea:'فكرة',event:'حدث',comicTitle:'قصتي المصورة',comicLine:'!قل شيئًا',certTitle:'شهادة تقدير',certPresented:'تُمنح هذه الشهادة بكل فخر إلى',certName:'اسم الطالب',certFor:'للعمل المتميز',certDate:'التاريخ',certSignature:'التوقيع'},
  zh:{frayerTitle:'Frayer 模型',definition:'定义',characteristics:'特征',examples:'例子',nonExamples:'非例子',kwlKnow:'已知',kwlWant:'想知道',kwlLearned:'已学',sideA:'A 面',sideB:'B 面',caption:'说明',both:'共同点',mainIdea:'主要想法',idea:'想法',event:'事件',comicTitle:'我的漫画',comicLine:'说点什么吧！',certTitle:'成就证书',certPresented:'谨将此证书授予',certName:'学生姓名',certFor:'以表彰其出色表现',certDate:'日期',certSignature:'签名'},
  uh:{frayerTitle:'Frayer मॉडल / فراير ماڈل',definition:'परिभाषा / تعریف',characteristics:'विशेषताएँ / خصوصیات',examples:'उदाहरण / مثالیں',nonExamples:'गैर-उदाहरण / غیر مثالیں',kwlKnow:'जानता हूँ / جانتا ہوں',kwlWant:'जानना चाहता हूँ / جاننا چاہتا ہوں',kwlLearned:'सीखा / سیکھا',sideA:'पक्ष A / طرف A',sideB:'पक्ष B / طرف B',caption:'कैप्शन / عنوان',both:'दोनों / دونوں',mainIdea:'मुख्य विचार / مرکزی خیال',idea:'विचार / خیال',event:'घटना / واقعہ',comicTitle:'मेरी कॉमिक / میری کامک',comicLine:'कुछ कहो! / کچھ کہو!',certTitle:'उपलब्धि प्रमाणपत्र / سند کامیابی',certPresented:'यह प्रमाणपत्र गर्व से प्रदान किया जाता है / یہ سند فخر سے پیش کی جاتی ہے',certName:'छात्र का नाम / طالبعلم کا نام',certFor:'उत्कृष्ट कार्य के लिए / بہترین کام کے لیے',certDate:'दिनांक / تاریخ',certSignature:'हस्ताक्षर / دستخط'}
};
...
function scheduleStartupTip(delay=900){
  const ready=()=>{
    ...
    if(welcomeOpen||consentOpen||gid('entryRoleDialog')?.open) return false;
    return true;
  };
...
function learnerActionKey(target){
  if(/Video/i.test(target))return 'video';
...
const CHEMISTRY_STAMPS=[{"id":"chemistry-atom-h","theme":"Chemistry","icon":"⚛","label":"Hydrogen atom (H)","formula":"H","shape":"Atom","atoms":["H"],"path":"assets/stamps/chemistry/atom-h.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Hydrogen atom (H)</title><g data-element=\"H\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">H</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">H</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-he","theme":"Chemistry","icon":"⚛","label":"Helium atom (He)","formula":"He","shape":"Atom","atoms":["He"],"path":"assets/stamps/chemistry/atom-he.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Helium atom (He)</title><g data-element=\"He\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#bde6f5\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">He</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">He</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-c","theme":"Chemistry","icon":"⚛","label":"Carbon atom (C)","formula":"C","shape":"Atom","atoms":["C"],"path":"assets/stamps/chemistry/atom-c.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Carbon atom (C)</title><g data-element=\"C\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#374151\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#fff\">C</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">C</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-n","theme":"Chemistry","icon":"⚛","label":"Nitrogen atom (N)","formula":"N","shape":"Atom","atoms":["N"],"path":"assets/stamps/chemistry/atom-n.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Nitrogen atom (N)</title><g data-element=\"N\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#3b82f6\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#fff\">N</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">N</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-o","theme":"Chemistry","icon":"⚛","label":"Oxygen atom (O)","formula":"O","shape":"Atom","atoms":["O"],"path":"assets/stamps/chemistry/atom-o.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Oxygen atom (O)</title><g data-element=\"O\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#fff\">O</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">O</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-f","theme":"Chemistry","icon":"⚛","label":"Fluorine atom (F)","formula":"F","shape":"Atom","atoms":["F"],"path":"assets/stamps/chemistry/atom-f.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Fluorine atom (F)</title><g data-element=\"F\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#86efac\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">F</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">F</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-na","theme":"Chemistry","icon":"⚛","label":"Sodium atom (Na)","formula":"Na","shape":"Atom","atoms":["Na"],"path":"assets/stamps/chemistry/atom-na.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Sodium atom (Na)</title><g data-element=\"Na\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#c4b5fd\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">Na</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Na</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-mg","theme":"Chemistry","icon":"⚛","label":"Magnesium atom (Mg)","formula":"Mg","shape":"Atom","atoms":["Mg"],"path":"assets/stamps/chemistry/atom-mg.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Magnesium atom (Mg)</title><g data-element=\"Mg\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#a7f3d0\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">Mg</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Mg</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-al","theme":"Chemistry","icon":"⚛","label":"Aluminum atom (Al)","formula":"Al","shape":"Atom","atoms":["Al"],"path":"assets/stamps/chemistry/atom-al.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Aluminum atom (Al)</title><g data-element=\"Al\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#cbd5e1\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">Al</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Al</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-si","theme":"Chemistry","icon":"⚛","label":"Silicon atom (Si)","formula":"Si","shape":"Atom","atoms":["Si"],"path":"assets/stamps/chemistry/atom-si.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Silicon atom (Si)</title><g data-element=\"Si\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#f5d0a9\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">Si</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Si</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-s","theme":"Chemistry","icon":"⚛","label":"Sulfur atom (S)","formula":"S","shape":"Atom","atoms":["S"],"path":"assets/stamps/chemistry/atom-s.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Sulfur atom (S)</title><g data-element=\"S\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#facc15\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">S</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">S</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-atom-cl","theme":"Chemistry","icon":"⚛","label":"Chlorine atom (Cl)","formula":"Cl","shape":"Atom","atoms":["Cl"],"path":"assets/stamps/chemistry/atom-cl.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Chlorine atom (Cl)</title><g data-element=\"Cl\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">Cl</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Cl</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Atom</text></svg>"},{"id":"chemistry-hydrogen","theme":"Chemistry","icon":"⚛","label":"Hydrogen molecule (H₂)","formula":"H₂","shape":"Diatomic molecule","atoms":["H","H"],"path":"assets/stamps/chemistry/hydrogen.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Hydrogen molecule (H₂)</title><path d=\"M48.0 65.0 L112.0 65.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"H\"><circle cx=\"48\" cy=\"65\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"112\" cy=\"65\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">H₂</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Diatomic molecule</text></svg>"},{"id":"chemistry-oxygen","theme":"Chemistry","icon":"⚛","label":"Oxygen molecule (O₂)","formula":"O₂","shape":"Diatomic molecule","atoms":["O","O"],"path":"assets/stamps/chemistry/oxygen.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Oxygen molecule (O₂)</title><path d=\"M48.0 62.5 L112.0 62.5\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M48.0 67.5 L112.0 67.5\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"O\"><circle cx=\"48\" cy=\"65\" r=\"17\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">O</text></g><g data-element=\"O\"><circle cx=\"112\" cy=\"65\" r=\"17\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">O</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">O₂</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Diatomic molecule</text></svg>"},{"id":"chemistry-nitrogen","theme":"Chemistry","icon":"⚛","label":"Nitrogen molecule (N₂)","formula":"N₂","shape":"Diatomic molecule","atoms":["N","N"],"path":"assets/stamps/chemistry/nitrogen.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Nitrogen molecule (N₂)</title><path d=\"M48.0 60.0 L112.0 60.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M48.0 65.0 L112.0 65.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M48.0 70.0 L112.0 70.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"N\"><circle cx=\"48\" cy=\"65\" r=\"17\" fill=\"#3b82f6\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">N</text></g><g data-element=\"N\"><circle cx=\"112\" cy=\"65\" r=\"17\" fill=\"#3b82f6\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">N</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">N₂</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Diatomic molecule</text></svg>"},{"id":"chemistry-chlorine","theme":"Chemistry","icon":"⚛","label":"Chlorine molecule (Cl₂)","formula":"Cl₂","shape":"Diatomic molecule","atoms":["Cl","Cl"],"path":"assets/stamps/chemistry/chlorine.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Chlorine molecule (Cl₂)</title><path d=\"M48.0 65.0 L112.0 65.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"Cl\"><circle cx=\"48\" cy=\"65\" r=\"17\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Cl</text></g><g data-element=\"Cl\"><circle cx=\"112\" cy=\"65\" r=\"17\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Cl</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">Cl₂</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Diatomic molecule</text></svg>"},{"id":"chemistry-water","theme":"Chemistry","icon":"⚛","label":"Water (H₂O)","formula":"H₂O","shape":"Bent","atoms":["O","H","H"],"path":"assets/stamps/chemistry/water.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Water (H₂O)</title><path d=\"M80.0 48.0 L36.0 82.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 48.0 L124.0 82.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"O\"><circle cx=\"80\" cy=\"48\" r=\"17\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"53\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">O</text></g><g data-element=\"H\"><circle cx=\"36\" cy=\"82\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"36\" y=\"87\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"124\" cy=\"82\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"124\" y=\"87\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">H₂O</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Bent</text></svg>"},{"id":"chemistry-carbon-dioxide","theme":"Chemistry","icon":"⚛","label":"Carbon dioxide (CO₂)","formula":"CO₂","shape":"Linear","atoms":["C","O","O"],"path":"assets/stamps/chemistry/carbon-dioxide.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Carbon dioxide (CO₂)</title><path d=\"M80.0 67.5 L26.0 67.5\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 62.5 L26.0 62.5\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 62.5 L134.0 62.5\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 67.5 L134.0 67.5\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"C\"><circle cx=\"80\" cy=\"65\" r=\"17\" fill=\"#374151\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">C</text></g><g data-element=\"O\"><circle cx=\"26\" cy=\"65\" r=\"17\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"26\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">O</text></g><g data-element=\"O\"><circle cx=\"134\" cy=\"65\" r=\"17\" fill=\"#ef4444\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"134\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">O</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">CO₂</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Linear</text></svg>"},{"id":"chemistry-methane","theme":"Chemistry","icon":"⚛","label":"Methane (CH₄)","formula":"CH₄","shape":"Tetrahedral","atoms":["C","H","H","H","H"],"path":"assets/stamps/chemistry/methane.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Methane (CH₄)</title><path d=\"M80.0 64.0 L80.0 21.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 64.0 L30.0 92.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80 64 L97.6 100.8 L110.4 91.2 Z\" fill=\"#475569\"/><path d=\"M89.89742928896759 58.69331615131571 L90.90257071103242 61.30668384868429\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M94.84614393345137 56.03997422697358 L96.35385606654862 59.96002577302642\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M99.79485857793516 53.38663230263143 L101.80514142206484 58.61336769736857\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M104.74357322241896 50.73329037828929 L107.25642677758104 57.26670962171071\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M109.69228786690275 48.07994845394715 L112.70771213309726 55.92005154605285\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M114.64100251138655 45.42660652960501 L118.15899748861347 54.57339347039499\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M119.58971715587033 42.77326460526287 L123.61028284412966 53.22673539473713\" stroke=\"#475569\" stroke-width=\"2\"/><g data-element=\"C\"><circle cx=\"80\" cy=\"64\" r=\"17\" fill=\"#374151\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"69\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">C</text></g><g data-element=\"H\"><circle cx=\"80\" cy=\"21\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"26\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"30\" cy=\"92\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"30\" y=\"97\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"104\" cy=\"96\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"104\" y=\"101\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"132\" cy=\"44\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"132\" y=\"49\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">CH₄</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Tetrahedral</text></svg>"},{"id":"chemistry-ammonia","theme":"Chemistry","icon":"⚛","label":"Ammonia (NH₃)","formula":"NH₃","shape":"Trigonal pyramidal","atoms":["N","H","H","H"],"path":"assets/stamps/chemistry/ammonia.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Ammonia (NH₃)</title><path d=\"M80.0 48.0 L32.0 82.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80 48 L72.0 100.0 L88.0 100.0 Z\" fill=\"#475569\"/><path d=\"M90.40922427709246 53.657565726457676 L88.79077572290753 55.94243427354232\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M95.61383641563872 56.48634858968653 L93.1861635843613 59.91365141031348\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M100.81844855418495 59.31513145291537 L97.58155144581505 63.884868547084636\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M106.02306069273119 62.143914316144205 L101.97693930726881 67.8560856838558\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M111.22767283127742 64.97269717937306 L106.37232716872258 71.82730282062695\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M116.43228496982366 67.80148004260188 L110.76771503017633 75.79851995739811\" stroke=\"#475569\" stroke-width=\"2\"/><path d=\"M121.63689710836991 70.63026290583073 L115.1631028916301 79.76973709416927\" stroke=\"#475569\" stroke-width=\"2\"/><circle cx=\"74\" cy=\"21\" r=\"3\" fill=\"#334155\"/><circle cx=\"86\" cy=\"21\" r=\"3\" fill=\"#334155\"/><g data-element=\"N\"><circle cx=\"80\" cy=\"48\" r=\"17\" fill=\"#3b82f6\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"53\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#fff\">N</text></g><g data-element=\"H\"><circle cx=\"32\" cy=\"82\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"32\" y=\"87\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"80\" cy=\"100\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"105\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"H\"><circle cx=\"128\" cy=\"82\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"128\" y=\"87\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">NH₃</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Trigonal pyramidal</text></svg>"},{"id":"chemistry-boron-trifluoride","theme":"Chemistry","icon":"⚛","label":"Boron trifluoride (BF₃)","formula":"BF₃","shape":"Trigonal planar","atoms":["B","F","F","F"],"path":"assets/stamps/chemistry/boron-trifluoride.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Boron trifluoride (BF₃)</title><path d=\"M80.0 65.0 L80.0 19.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 65.0 L38.0 90.0\" stroke=\"#475569\" stroke-width=\"3\"/><path d=\"M80.0 65.0 L122.0 90.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"B\"><circle cx=\"80\" cy=\"65\" r=\"17\" fill=\"#f8cda5\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">B</text></g><g data-element=\"F\"><circle cx=\"80\" cy=\"19\" r=\"17\" fill=\"#86efac\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"24\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">F</text></g><g data-element=\"F\"><circle cx=\"38\" cy=\"90\" r=\"17\" fill=\"#86efac\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"38\" y=\"95\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">F</text></g><g data-element=\"F\"><circle cx=\"122\" cy=\"90\" r=\"17\" fill=\"#86efac\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"122\" y=\"95\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">F</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">BF₃</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Trigonal planar</text></svg>"},{"id":"chemistry-hydrogen-chloride","theme":"Chemistry","icon":"⚛","label":"Hydrogen chloride (HCl)","formula":"HCl","shape":"Linear","atoms":["H","Cl"],"path":"assets/stamps/chemistry/hydrogen-chloride.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Hydrogen chloride (HCl)</title><path d=\"M48.0 65.0 L112.0 65.0\" stroke=\"#475569\" stroke-width=\"3\"/><g data-element=\"H\"><circle cx=\"48\" cy=\"65\" r=\"17\" fill=\"#f8fafc\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">H</text></g><g data-element=\"Cl\"><circle cx=\"112\" cy=\"65\" r=\"17\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"70\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Cl</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">HCl</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Linear</text></svg>"},{"id":"chemistry-sodium-chloride","theme":"Chemistry","icon":"⚛","label":"Sodium chloride lattice (NaCl)","formula":"NaCl","shape":"Ionic lattice","atoms":["Na⁺","Cl⁻","Cl⁻","Na⁺"],"path":"assets/stamps/chemistry/sodium-chloride.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Sodium chloride lattice (NaCl)</title><g data-element=\"Na⁺\"><circle cx=\"48\" cy=\"35\" r=\"17\" fill=\"#c4b5fd\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"40\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Na⁺</text></g><g data-element=\"Cl⁻\"><circle cx=\"112\" cy=\"35\" r=\"17\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"40\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Cl⁻</text></g><g data-element=\"Cl⁻\"><circle cx=\"48\" cy=\"95\" r=\"17\" fill=\"#22c55e\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"48\" y=\"100\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Cl⁻</text></g><g data-element=\"Na⁺\"><circle cx=\"112\" cy=\"95\" r=\"17\" fill=\"#c4b5fd\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"112\" y=\"100\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"15\" font-weight=\"700\" fill=\"#172033\">Na⁺</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">NaCl</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Ionic lattice</text></svg>"},{"id":"chemistry-proton","theme":"Chemistry","icon":"⚛","label":"Proton (p⁺)","formula":"p⁺","shape":"Subatomic particle","atoms":[],"path":"assets/stamps/chemistry/proton.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Proton (p⁺)</title><g data-particle=\"p⁺\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#dbeafe\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">p⁺</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">p⁺</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Subatomic particle</text></svg>","particles":["p⁺"]},{"id":"chemistry-neutron","theme":"Chemistry","icon":"⚛","label":"Neutron (n⁰)","formula":"n⁰","shape":"Subatomic particle","atoms":[],"path":"assets/stamps/chemistry/neutron.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Neutron (n⁰)</title><g data-particle=\"n⁰\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#dbeafe\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">n⁰</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">n⁰</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Subatomic particle</text></svg>","particles":["n⁰"]},{"id":"chemistry-electron","theme":"Chemistry","icon":"⚛","label":"Electron (e⁻)","formula":"e⁻","shape":"Subatomic particle","atoms":[],"path":"assets/stamps/chemistry/electron.svg","svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 160 160\" width=\"160\" height=\"160\"><title>Electron (e⁻)</title><g data-particle=\"e⁻\"><circle cx=\"80\" cy=\"65\" r=\"30\" fill=\"#dbeafe\" stroke=\"#334155\" stroke-width=\"2\"/><text x=\"80\" y=\"73\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"24\" font-weight=\"700\" fill=\"#172033\">e⁻</text></g><text x=\"80\" y=\"134\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"19\" font-weight=\"700\" fill=\"#172033\">e⁻</text><text x=\"80\" y=\"153\" text-anchor=\"middle\" font-family=\"Arial,sans-serif\" font-size=\"11\" font-weight=\"700\" fill=\"#172033\">Subatomic particle</text></svg>","particles":["e⁻"]}];
const FUN_STAMPS=Object.entries(STAMP_THEMES).flatMap(([theme,items])=>items.map(([icon,label],index)=>({id:theme.toLowerCase()+'_'+index,theme,icon,label}))).concat(CHEMISTRY_STAMPS.map(s=>({...s,src:'data:image/svg+xml;charset=utf-8,'+encodeURIComponent(s.svg)})));
let chosenStamp=FUN_STAMPS[0],stampSize=80,stampRecent=[],stampRotation=0,stampFlipped=false,stampPreviewPoint=null,stampPreviewFrame=0;
function refreshStampTools(){const stampButton=gid('funStampToolBtn');if(!stampButton)return;stampButton.hidden=!learnerAllows('stamp');const beginner=document.body.dataset.learnerView==='beginner';if(beginner&&stampButton.parentElement!==gid('learnerPrimaryTools'))gid('learnerPrimaryTools').append(stampButton);else if(!beginner&&stampButton.parentElement!==gid('toolButtons'))gid('toolButtons').insertBefore(stampButton,gid('drawToolGroup'));stampButton.classList.toggle('student-tool-hidden',!learnerAllows('stamp'));gid('stampActiveBar').hidden=tool!=='stamp'||!learnerAllows('stamp');const text=chosenStamp.icon+' '+chosenStamp.label+(stampRotation?' · '+stampRotation+'°':'')+(stampFlipped?' · flipped':'');const label=gid('stampActiveLabel');if(label.textContent!==text)label.textContent=text;gid('stampSize').value=String(stampSize);gid('stampFlip').setAttribute('aria-pressed',String(stampFlipped));if(tool!=='stamp'){stampPreviewPoint=null;svg.querySelector('.stamp-preview')?.remove()}}
function funStampProps(){return {stampId:chosenStamp.id,stampIcon:chosenStamp.icon,stampSrc:chosenStamp.src||'',stampFormula:chosenStamp.formula||'',stampModelShape:chosenStamp.shape||'',stampLabel:chosenStamp.label,stampPlain:true,stampRotation,stampFlipped,stampBg:'transparent',fill:'none',stroke:'none',strokeWidth:0}}
function drawStampPreview(){
  svg.querySelector('.stamp-preview')?.remove();const viewport=svg.querySelector('#viewport');if(!viewport||tool!=='stamp'||!stampPreviewPoint||!learnerAllows('stamp')||document.querySelector('dialog[open]'))return;
  const b={x:stampPreviewPoint.x-stampSize/2,y:stampPreviewPoint.y-stampSize/2,w:stampSize,h:stampSize},g=document.createElementNS(NS,'g');g.classList.add('stamp-preview');g.setAttribute('aria-hidden','true');g.appendChild(createStampObject({...funStampProps(),opacity:.45},b));g.appendChild(svgEl(`<rect x="${b.x}" y="${b.y}" width="${b.w}" height="${b.h}" rx="8" fill="none" stroke="#6d38e8" stroke-width="${1.5/zoom}" stroke-dasharray="${4/zoom} ${3/zoom}"/>`));viewport.appendChild(g);
}
function updateStampOrientation(rotation,flipped){stampRotation=(rotation%360+360)%360;stampFlipped=flipped;refreshStampTools();drawStampPreview()}
function stampSearchText(value){return String(value).toLowerCase().replace(/[₀-₉]/g,c=>String('₀₁₂₃₄₅₆₇₈₉'.indexOf(c)))}
function renderStampTray(){
  const query=stampSearchText(gid('stampSearch').value.trim()),theme=gid('stampTheme').value,grid=gid('funStampGrid');grid.replaceChildren();
  const stamps=(theme==='Recent'?stampRecent.map(id=>FUN_STAMPS.find(s=>s.id===id)).filter(Boolean):FUN_STAMPS).filter(s=>(theme==='All'||theme==='Recent'||s.theme===theme)&&(!query||stampSearchText(s.label+' '+s.theme+' '+(s.formula||'')+' '+(s.shape||'')).includes(query)));
  gid('stampChemistryGuide').hidden=theme!=='Chemistry';
  ...
  for(const stamp of stamps){const button=document.createElement('button');button.type='button';button.className='fun-stamp-tile';button.setAttribute('aria-label',stamp.label+' stamp');const icon=document.createElement('span');icon.className='fun-stamp-icon';if(stamp.src){const image=document.createElement('img');image.src=stamp.src;image.alt='';icon.append(image)}else icon.textContent=stamp.icon;icon.setAttribute('aria-hidden','true');const label=document.createElement('span');label.textContent=stamp.label;button.append(icon,label);button.onclick=()=>{if(!learnerAllows('stamp'))return;chosenStamp=stamp;if(stamp.theme==='Chemistry')stampSize=160;stampRecent=[stamp.id,...stampRecent.filter(id=>id!==stamp.id)].slice(0,12);writePreference('drawsplat.stamps.recent',JSON.stringify(stampRecent));clearSelection();setTool('stamp');gid('funStampDialog').close();svg.focus();setStatus(stamp.label+' stamp ready. Tap the page again and again, or press Enter to stamp in the middle.','success')};grid.append(button)}
}
function openStampTray(){stampPreviewPoint=null;drawStampPreview();if(!learnerAllows('stamp'))return setStatus('Pictures and stamps are not in this lesson.','danger');document.querySelectorAll('#toolButtons details[open]').forEach(d=>d.open=false);renderStampTray();gid('funStampDialog').showModal()}
function placeFunStamp(p){if(!learnerAllows('stamp'))return;const stamp=makeObj('stamp',p.x-stampSize/2,p.y-stampSize/2,stampSize,stampSize,funStampProps());panel().objects.push(stamp);clearSelection();render();saveState()}
...
function ensureFunStamps(){
  ...
  const active=document.createElement('div');active.id='stampActiveBar';active.className='stamp-active-bar';active.hidden=true;active.innerHTML='<strong id="stampActiveLabel" role="status"></strong><label>Size <select id="stampSize"><option value="48">Small</option><option value="80" selected>Medium</option><option value="120">Large</option><option value="160">Extra large</option></select></label><button type="button" id="stampTurnLeft" title="Turn 45 degrees left">↶ Turn left</button><button type="button" id="stampTurnRight" title="Turn 45 degrees right">↷ Turn right</button><button type="button" id="stampFlip" aria-pressed="false">Flip stamp</button><button type="button" id="stampReset">Reset stamp</button><button type="button" id="stampChoose">Change stamp</button><button type="button" id="stampMiddle">Stamp in middle</button><button type="button" id="stampDone">Done stamping</button>';gid('learnerToolbar').append(active);gid('stampSize').onchange=()=>{stampSize=+gid('stampSize').value||80;drawStampPreview()};gid('stampTurnLeft').onclick=()=>updateStampOrientation(stampRotation-45,stampFlipped);gid('stampTurnRight').onclick=()=>updateStampOrientation(stampRotation+45,stampFlipped);gid('stampFlip').onclick=()=>updateStampOrientation(stampRotation,!stampFlipped);gid('stampReset').onclick=()=>{stampSize=chosenStamp.theme==='Chemistry'?160:80;updateStampOrientation(0,false)};gid('stampChoose').onclick=openStampTray;gid('stampMiddle').onclick=stampAtCenter;gid('stampDone').onclick=()=>setTool('select');
  const dlg=addLearnerDialog('funStampDialog','Fun Stamps','<p>Pick a stamp, then tap anywhere on your page. Keep tapping to make a scene, pattern, or picture graph. Use Undo for a do-over.</p><div class="stamp-tray-filters"><label>Find a stamp<input id="stampSearch" type="search" placeholder="Try frog, rocket, music…" autocomplete="off"></label><label>Tray<select id="stampTheme"><option>All</option><option>Recent</option>'+Object.keys(STAMP_THEMES).map(t=>'<option>'+t+'</option>').join('')+'</select></label></div><p id="stampChemistryGuide" hidden>Read the symbols on the atoms; colors help tell them apart. Lines show covalent bonds. Wedges point toward you; dashed wedges point away. NaCl shows an ionic lattice. Models are not to scale.</p><p id="stampTrayCount" role="status"></p><div id="funStampGrid" class="fun-stamp-grid"></div>');gid('stampSearch').oninput=renderStampTray;gid('stampTheme').onchange=renderStampTray;
  ...
  svg.addEventListener('pointermove',e=>{if(tool!=='stamp'||e.pointerType==='touch')return;stampPreviewPoint=e.target.closest('.audio-controls')?null:pt(e);if(!stampPreviewFrame)stampPreviewFrame=requestAnimationFrame(()=>{stampPreviewFrame=0;drawStampPreview()})});svg.addEventListener('pointerleave',()=>{stampPreviewPoint=null;drawStampPreview()});
...
const ENTRY_ROLE_KEY='drawsplat.entryRole';
function ensureEntryRoleChooser(){
  const button=document.createElement('button');button.id='entryRoleButton';button.type='button';button.className='everyday-action';
  gid('learnerToolbar').querySelector('.learner-secondary-tools').prepend(button);
  const dialog=addLearnerDialog('entryRoleDialog','Are you a teacher or student?',`<p>Choose the tools that fit what you are doing. We remember your choice on this device.</p><div class="entry-role-choices"><button id="entryRoleTeacher" type="button" class="learner-starter-card"><span class="entry-role-icon" aria-hidden="true">👩‍🏫</span><strong>I am a teacher</strong><span>Create lessons, choose student tools, and use classroom features.</span></button><button id="entryRoleStudent" type="button" class="learner-starter-card"><span class="entry-role-icon" aria-hidden="true">🎒</span><strong>I am a student</strong><span>Draw, type, stamp, and complete your teacher’s activities with fewer controls.</span></button></div><p class="hint">This chooses your view. Teacher Admin still needs its password. Classroom links keep the teacher’s student settings.</p>`);
  const choose=(role,restore=false)=>{
    if(roleLock==='student')return;
    if(!restore&&board.mode==='teacher'&&role==='student')writePreference('drawsplat.teacherView',ui.interfaceMode.value);
    board.mode=role;ui.userMode.value=role;
    if(role==='student'&&!board.assignmentMode)board.showAnswerKey=false;
    if(role==='teacher'&&!restore){applyInterfaceMode(readPreference('drawsplat.teacherView')||'simple',true);applyWorkspaceMode('education',true)}
    try{localStorage.setItem(ENTRY_ROLE_KEY,role)}catch(_){}
    applyModeUI();refreshLearnerWorkspace();persistLocal();render();dialog.close();
    document.dispatchEvent(new CustomEvent('drawsplat:entry-role-chosen'));
  };
  gid('entryRoleTeacher').onclick=()=>choose('teacher');gid('entryRoleStudent').onclick=()=>choose('student');
  button.onclick=()=>{if(roleLock!=='student'){dialog.querySelector('.close').hidden=false;dialog.dataset.required='';dialog.showModal()}};
  dialog.addEventListener('cancel',e=>{if(dialog.dataset.required==='true')e.preventDefault()});
  const explicit=new URLSearchParams(location.search).get('role');
  if(explicit==='student'||explicit==='teacher'){if(explicit==='teacher')board.mode='teacher';applyModeUI();refreshLearnerWorkspace();render();return false}
  let saved;try{saved=localStorage.getItem(ENTRY_ROLE_KEY)}catch(_){}
  if(saved==='teacher'||saved==='student'){choose(saved,true);return false}
  dialog.dataset.required='true';dialog.querySelector('.close').hidden=true;dialog.showModal();return true;
}
function refreshEntryRoleButton(){
  const button=gid('entryRoleButton');if(!button)return;
  button.hidden=roleLock==='student';
  // Keep the button contents stable during the canvas pointer-up render.
  if(button.dataset.role!==board.mode){button.dataset.role=board.mode;button.innerHTML=everydayToolIcon(board.mode==='student'?'student':'teacher')+(board.mode==='student'?'Student view':'Teacher view')}
  button.title='Change between teacher and student tools';
}
...
function prepareVideoNoteExport(clone){
  for(const card of clone.querySelectorAll('.video-note-card')){
    const object=findObj(card.dataset.videoNoteId),video=card.querySelector('video');
    if(video){if(window.DrawSplatVideoNotes.validPoster(object?.videoPoster)){const image=document.createElementNS(XHTML,'img');image.src=object.videoPoster;image.alt='Video note still picture';image.style.cssText=video.style.cssText;image.style.objectFit='contain';video.replaceWith(image)}else{const text=document.createElementNS(XHTML,'p');text.textContent='Video note — play it in the saved board file.';video.replaceWith(text)}}
    card.querySelector('.video-note-actions')?.remove();
  }
}
...
function ensureLearnerWorkspace(){
  ...
  toolbar.innerHTML=`<div id="learnerPrimaryTools">${[['select','↖','Move'],['pen','✎','Pencil'],['eraser','⌫','Eraser'],['text','T','Type']].map(([key,symbol,label])=>`<button type="button" data-learner-tool="${key}"><span aria-hidden="true">${symbol}</span>${label}</button>`).join('')}<label class="learner-color">Colors<input id="learnerColor" type="color" aria-label="Choose a color" value="#7c3aed"></label><button type="button" id="learnerPicture">Picture</button><label id="learnerPenSizeLabel" class="learner-pen-size" hidden>Pencil size<select id="learnerPenSize" aria-label="Pencil size"><option value="2">Thin</option><option value="4" selected>Medium</option><option value="8">Thick</option><option value="12">Extra thick</option></select></label></div><div class="learner-secondary-tools"><button type="button" id="learnerUndo" title="Undo your last change (Ctrl/Cmd+Z)">Undo</button><button type="button" id="learnerResponse">My response</button><button type="button" id="learnerHelp">Show me how</button><button type="button" id="learnerObjects">Find an item</button><button type="button" id="learnerPan" aria-pressed="false">Move view</button><button type="button" id="learnerHome">Center view</button><button type="button" id="learnerStarters" class="teacher-only">Lesson starters</button><button type="button" id="learnerTurnIn" data-workspace="education">Check &amp; turn in</button></div>`;
  document.querySelector('.stage-wrap').prepend(toolbar);
  const everyday=toolbar.querySelector('.learner-secondary-tools');
  const redoButton=gid('sidebarRedoBtn'),audioButton=gid('sidebarAudioToggleBtn');redoButton.textContent='Redo';
  everyday.insertBefore(redoButton,gid('learnerUndo').nextSibling);everyday.insertBefore(audioButton,redoButton.nextSibling);
  gid('sidebarUndoRow').hidden=true;
  for(const [key,icon] of [['learnerUndo','undo'],['sidebarRedoBtn','redo'],['learnerResponse','response'],['learnerHelp','help'],['learnerObjects','find'],['learnerPan','pan'],['learnerHome','home'],['learnerStarters','lesson'],['learnerTurnIn','check']]){const button=gid(key);button.innerHTML=everydayToolIcon(icon)+button.textContent;button.classList.add('everyday-action')}
  ...
  for(const option of ui.templateSelect.options){const button=document.createElement('button');button.type='button';button.className='learner-starter-card';button.dataset.starterLayout=option.value;button.innerHTML=everydayToolIcon('lesson')+'<strong>'+esc(option.textContent)+'</strong><span>'+esc(layoutDetails[option.value]||'Start with this ready-made layout.')+'</span>';button.onclick=()=>{if(board.mode==='student')return;ui.templateSelect.value=option.value;const before=board.panels.length;insertTemplate(true,option.textContent);if(board.panels.length>before)starters.close()};gid('learnerLayoutList').append(button)}
...
function validateBoard(b){
  ...
  for(const p of b.panels){
    ...
    for(const o of p.objects||[]){
      ...
      if(o.type==='video'){if(o.videoSrc&&!window.DrawSplatVideoNotes.validSource(o.videoSrc))throw new Error('Invalid video note or video exceeds 5 MB');if(o.videoDuration!==undefined&&(!Number.isFinite(o.videoDuration)||o.videoDuration<0||o.videoDuration>30))throw new Error('Video notes must be 30 seconds or less');}
...
function resetInteractionState(){stampPreviewPoint=null;commitInlineTextEditor?.(true); selectedIds=[]; connectorPendingFrom=null; marquee=null; drawing=null; liveDrawingPathEl=null; drag=null; scratchErase=null; eraserDirty=false}
...
function createAudioObject(o,b){
  ...
  const title=document.createElementNS(XHTML,'div');title.className='audio-note-title';title.innerHTML=objectHtml(o,o.audioName||'Voice note');d.appendChild(title);
...
const CLASSROOM_TOOL_LINKS=[
  ...
  {title:'MemeSplat™',summary:'Create captioned memes locally from templates or your own images.',url:appPath('solutions/memesplat/index.html')},
  ...
  {title:'ImageSplat™',summary:'Edit screenshots and images with annotations, layers, crop, clipboard import/export, GIF creation, and frame downloads.',url:appPath('solutions/imagesplat/index.html')},
...
ui.userMode.onchange=()=>{board.mode=ui.userMode.value;if(roleLock!=='student')writePreference(ENTRY_ROLE_KEY,board.mode); if(board.mode==='student'&&!board.assignmentMode) board.showAnswerKey=false; applyModeUI(); saveState(false); render()};
...
async function exportCanvas(){
  ...
  clone.querySelectorAll('.selection,.handle,.laser-trail,.marquee,.stamp-preview').forEach(el=>el.remove());
...
function templateObjects(name){const objs=[]; const add=(o)=>objs.push(o);
  ...
  if(name==='comic'){const title=tplText('comicTitle'); add(makeObj('rect',50,20,540,46,{fill:'#1E398D',stroke:'#1E398D',html:title,text:title,hAlign:'center',vAlign:'middle',fontSize:24,textColor:'#ffffff'})); for(let i=0;i<3;i++){const x=50+i*185,y=84; add(makeObj('rect',x,y,175,190,{fill:'#ffffff',strokeWidth:3})); add(makeObj('speech',x+16,y+18,130,74,{fill:'#fff7e6',html:tplText('comicLine'),text:tplText('comicLine'),fontSize:16,hAlign:'center',vAlign:'middle',autoScaleText:true})); add(makeObj('text',x+10,y+150,155,30,{fill:'none',stroke:'none',html:tplText('caption'),text:tplText('caption'),fontSize:15,hAlign:'center',autoScaleText:true}))}}
  if(name==='certificate'){add(makeObj('rect',40,30,560,360,{fill:'#fffef7',stroke:'#c9a227',strokeWidth:4})); add(makeObj('rect',62,52,516,316,{fill:'none',stroke:'#c9a227',strokeWidth:2})); add(makeObj('text',90,80,460,50,{fill:'none',stroke:'none',html:tplText('certTitle'),text:tplText('certTitle'),fontSize:30,hAlign:'center',textColor:'#5b21b6',autoScaleText:true})); add(makeObj('text',90,150,460,30,{fill:'none',stroke:'none',html:tplText('certPresented'),text:tplText('certPresented'),fontSize:18,hAlign:'center',autoScaleText:true})); add(makeObj('text',90,190,460,50,{fill:'none',stroke:'none',html:tplText('certName'),text:tplText('certName'),fontSize:32,hAlign:'center',autoScaleText:true})); add(makeObj('text',90,255,460,30,{fill:'none',stroke:'none',html:tplText('certFor'),text:tplText('certFor'),fontSize:18,hAlign:'center',autoScaleText:true})); add(makeObj('line',110,340,180,0,{fill:'none',strokeWidth:2})); add(makeObj('line',350,340,180,0,{fill:'none',strokeWidth:2})); add(makeObj('text',110,345,180,26,{fill:'none',stroke:'none',html:tplText('certDate'),text:tplText('certDate'),fontSize:14,hAlign:'center',autoScaleText:true})); add(makeObj('text',350,345,180,26,{fill:'none',stroke:'none',html:tplText('certSignature'),text:tplText('certSignature'),fontSize:14,hAlign:'center',autoScaleText:true}))}
  return objs}
...
function refreshAudioToggleBtn(){
  ...
  btn.innerHTML = everydayToolIcon(muted?'muted':'sound')+(muted?'Audio: Off':'Audio: On');btn.classList.add('everyday-action');
...
function playSelectedAudio(){const o=currentObj();if(!o||o.type!=='audio'||!o.audioSrc)return setStatus('Select an audio note with audio attached.','danger');controlNotePlayback(o,'play')}
...
(function(){
  ...
  function groupToolPalette(){
    ...
    const drawGroup=makeGroup({id:'drawToolGroup',label:'Draw Tools',icon:'pen',items:['pen','eraser','laser'],className:'tool-group-draw'});
    ...
    const bucketButton=tools.querySelector('[data-tool="bucket"]');bucketButton.classList.add('direct-bucket-tool');tools.append(drawGroup,bucketButton,shapeGroup,textGroup,insertGroup,bgGroup,gid('simpleDeleteBtn'),gid('simpleTntBtn'));gid('simpleDeleteBtn').classList.add('direct-delete-tool');gid('simpleTntBtn').classList.add('direct-tnt-tool');
