...
(function(){
  ...
  const buttonIcons={
    ...
    removeBgColorBtn:['magic','Remove BG Color'],simpleDeleteBtn:['pop_trash','Delete Selected'],floatDeselectBtn:['close','Deselect'],floatDeleteBtn:['trash','Delete'],floatDuplicateBtn:['duplicate','Duplicate'],floatSaveBtn:['save','Download selected content'],floatEditBtn:['edit','Edit Text'],floatCropBtn:['crop','Crop Image'],floatConceptChildBtn:['plus','Add Concept Child'],floatConceptLinkBtn:['concept','Set Concept Link'],
