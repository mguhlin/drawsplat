...
(function(){
  const TITLES={castles:'Castles',floodfill:'Flood Fill',flowfree:'Flow Free',funquiz:'Fun Quiz',gilasplat:'GilaSplat',lightsout:'Lights Out',splatball:'Splatball','squirrel-run-game':'Squirrel Run','super-star-trek':'Super Star Trek',tangram:'Tangram Packing','typing-games':'Typing Games',untangle:'Untangle'};
  function render(){
