(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={text:``,longText:``,number:0,currency:0,percent:0,date:``,checkbox:!1,rating:0,choice:``,image:``,link:``,calculation:``,autoNumber:``,createdAt:``,updatedAt:``};function t(e){return`${e}_${Math.random().toString(36).slice(2,10)}`}function n(e,n=`text`){return{id:t(`field`),name:e,type:n,description:``,required:!1,hidden:!1,options:n===`choice`?[`Yes`,`No`]:void 0}}function r(n,r={}){let i=new Date().toISOString(),a=Object.fromEntries(n.map((t,n)=>t.type===`createdAt`||t.type===`updatedAt`?[t.id,r[t.id]??i]:t.type===`autoNumber`?[t.id,r[t.id]??n+1]:r[t.id]===void 0&&t.defaultValue!=null&&t.defaultValue!==``?[t.id,u(t.defaultValue,t.type,t.options).value]:[t.id,r[t.id]??e[t.type]]));return{id:t(`record`),createdAt:i,updatedAt:i,values:a}}function i(e,i){let a=i.map(e=>n(e));return{id:t(`table`),name:e,fields:a,records:[r(a)]}}function a(e=`Animal Research Database`){let n=new Date().toISOString(),a=i(`Animals`,[`Animal`,`Habitat`,`Diet`,`Interesting Fact`]);return a.records=[r(a.fields,{[a.fields[0].id]:`Axolotl`,[a.fields[1].id]:`Freshwater lakes`,[a.fields[2].id]:`Worms and insects`,[a.fields[3].id]:`It can regrow some body parts.`}),r(a.fields,{[a.fields[0].id]:`Red panda`,[a.fields[1].id]:`Mountain forests`,[a.fields[2].id]:`Bamboo and fruit`,[a.fields[3].id]:`It uses its tail like a blanket.`})],{app:`ListSplatTM`,version:1,createdAt:n,updatedAt:n,metadata:{title:e,author:``,className:``},schema:{tables:[a],relationships:[]},layouts:[{id:t(`layout`),name:`Table View`,tableId:a.id,mode:`table`,locked:!1},{id:t(`layout`),name:`Record Form`,tableId:a.id,mode:`form`,locked:!1},{id:t(`layout`),name:`Research Cards`,tableId:a.id,mode:`cards`,locked:!1}],teacher:{studentView:!1,notes:[`Ask students to add source notes before printing a report.`],rubric:[]}}}function o(t,r,i=`text`){let a=n(r.trim()||`New Field`,i);return{...t,fields:[...t.fields,a],records:t.records.map(t=>({...t,updatedAt:new Date().toISOString(),values:{...t.values,[a.id]:e[i]}}))}}function s(e,t){return e.records.reduce((e,n)=>{let r=Number(n.values[t]);return Number.isFinite(r)?Math.max(e,r):e},0)+1}function c(e){let t={};return e.fields.filter(e=>e.type===`autoNumber`).forEach(n=>{t[n.id]=s(e,n.id)}),t}function l(e){return{...e,records:[...e.records,r(e.fields,c(e))]}}function u(t,n,r){let i=t==null?``:String(t);if(i.trim()===``)return{value:e[n],lost:!1};switch(n){case`number`:case`currency`:case`percent`:case`rating`:{let t=Number(i.replace(/[$,%\s]/g,``));return Number.isFinite(t)?{value:n===`rating`?Math.max(0,Math.min(5,Math.round(t))):t,lost:!1}:{value:e[n],lost:!0}}case`checkbox`:{let e=i.trim().toLowerCase();return[`true`,`yes`,`1`,`y`,`checked`].includes(e)?{value:!0,lost:!1}:[`false`,`no`,`0`,`n`].includes(e)?{value:!1,lost:!1}:{value:!1,lost:!0}}case`choice`:{let e=r?.find(e=>e.toLowerCase()===i.trim().toLowerCase());return e?{value:e,lost:!1}:{value:``,lost:!!(r&&r.length)}}case`date`:{let e=new Date(i);return Number.isNaN(e.getTime())?{value:``,lost:!0}:{value:e.toISOString().slice(0,10),lost:!1}}case`text`:case`longText`:case`link`:return{value:i,lost:!1};default:return{value:i,lost:!1}}}function d(e,t,n,r){return{...e,records:e.records.map(e=>({...e,values:{...e.values,[t]:u(e.values[t],n,r).value}}))}}function f(e,t,n){return{...e,fields:e.fields.map(e=>e.id===t?{...e,...n}:e)}}function p(e,t){let n=e.records.find(e=>e.id===t);return n?{...e,records:[...e.records,r(e.fields,{...n.values,...c(e)})]}:e}function ee(e,t){return e.records.length<=1?e:{...e,records:e.records.filter(e=>e.id!==t)}}function te(e,t,n,r){let i=new Date().toISOString();return{...e,records:e.records.map(a=>a.id===t?{...a,updatedAt:i,values:Object.fromEntries(e.fields.map(e=>e.id===n?[e.id,r]:e.type===`updatedAt`?[e.id,i]:[e.id,a.values[e.id]]))}:a)}}function ne(e,t){return{...e,updatedAt:new Date().toISOString(),schema:{...e.schema,tables:e.schema.tables.map(e=>e.id===t.id?t:e)}}}function re(e,n){let r=i(n.trim()||`New Table`,[`Name`,`Notes`]);return{...e,updatedAt:new Date().toISOString(),schema:{...e.schema,tables:[...e.schema.tables,r]},layouts:[...e.layouts,{id:t(`layout`),name:`${r.name} Table`,tableId:r.id,mode:`table`,locked:!1},{id:t(`layout`),name:`${r.name} Form`,tableId:r.id,mode:`form`,locked:!1}]}}function ie(e){if(!e||typeof e!=`object`)throw Error(`This is not a ListSplatTM project file.`);let t=e;if(t.app!==`ListSplatTM`||t.version!==1||!t.schema?.tables)throw Error(`This file is not a supported .listsplat.json project.`)}function ae(e){let t=e.split(/\r?\n/,1)[0]??``,n=[`,`,`	`,`;`],r=`,`,i=-1;for(let e of n){let n=t.split(e).length-1;n>i&&(i=n,r=e)}return r}function oe(e,t=ae(e)){let n=[],r=``,i=[],a=!1;for(let o=0;o<e.length;o+=1){let s=e[o],c=e[o+1];a&&s===`"`&&c===`"`?(r+=`"`,o+=1):s===`"`?a=!a:!a&&s===t?(i.push(r),r=``):!a&&(s===`
`||s===`\r`)?(s===`\r`&&c===`
`&&(o+=1),i.push(r),i.some(e=>e.length>0)&&n.push(i),i=[],r=``):r+=s}return i.push(r),i.some(e=>e.length>0)&&n.push(i),n}function se(e,t){let i=oe(t),a=(i[0]?.map((e,t)=>e.trim()||`Field ${t+1}`)??[`Field 1`]).map(e=>n(e)),o=i.slice(1).map(e=>r(a,Object.fromEntries(a.map((t,n)=>[t.id,e[n]??``]))));return{id:`table_${Date.now().toString(36)}`,name:e,fields:a,records:o.length>0?o:[r(a)]}}function ce(e){let t=e==null?``:String(e);return/[",\n\r]/.test(t)?`"${t.replaceAll(`"`,`""`)}"`:t}function le(e){return[e.fields.map(e=>ce(e.name)).join(`,`),...e.records.map(t=>e.fields.map(e=>ce(t.values[e.id])).join(`,`))].join(`
`)}var ue=`listsplat.autosave.v1`;function de(e){localStorage.setItem(ue,JSON.stringify(e))}function fe(){let e=localStorage.getItem(ue);if(!e)return null;let t=JSON.parse(e);return ie(t),t}function pe(e,t,n){let r=new Blob([t],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,a.click(),URL.revokeObjectURL(i)}function me(e){return e==null?``:String(e).trim().toLowerCase()}function he(e,n,r,i,a){return{id:t(`relationship`),name:e.trim()||`New Relationship`,fromTableId:n,fromFieldId:r,toTableId:i,toFieldId:a}}function ge(e,t){return{...e,updatedAt:new Date().toISOString(),schema:{...e.schema,relationships:[...e.schema.relationships,t]}}}function _e(e,t,n,r){let i=me(n.values[e.fromFieldId]);return!i||t.id!==e.fromTableId||r.id!==e.toTableId?[]:r.records.filter(t=>me(t.values[e.toFieldId])===i)}function ve(e,t){let n=e.schema.tables.find(e=>e.id===t.fromTableId),r=e.schema.tables.find(e=>e.id===t.toTableId),i=n?.fields.find(e=>e.id===t.fromFieldId),a=r?.fields.find(e=>e.id===t.toFieldId);return`${n?.name??`Table`}:${i?.name??`Field`} -> ${r?.name??`Table`}:${a?.name??`Field`}`}function ye(e,t){return e.records.map(e=>Number(e.values[t])).filter(e=>Number.isFinite(e))}function be(e){return e.fields.filter(e=>[`number`,`currency`,`percent`].includes(e.type)).map(t=>{let n=ye(e,t.id),r=n.reduce((e,t)=>e+t,0);return{fieldId:t.id,fieldName:t.name,count:n.length,sum:r,average:n.length?r/n.length:0,minimum:n.length?Math.min(...n):0,maximum:n.length?Math.max(...n):0}})}function xe(e){let t=[],n=``,r=!1;for(let i=0;i<e.length;i+=1){let a=e[i],o=e[i-1];if(a===`"`&&o!==`\\`){r=!r,n+=a;continue}if(a===`,`&&!r){t.push(n.trim()),n=``;continue}n+=a}return(n.trim()||e.endsWith(`,`))&&t.push(n.trim()),t}function Se(e){let t=e.trim();if(t.startsWith(`"`)&&t.endsWith(`"`))return t.slice(1,-1).replace(/\\"/g,`"`)}function Ce(e,t,n){let r=n.trim().toLowerCase(),i=e.fields.find(e=>e.name.toLowerCase()===r);return i?String(t.values[i.id]??``):``}function m(e,t,n){return Se(n)??Ce(e,t,n)}function h(e,t,n){let r=Number(m(e,t,n));return Number.isFinite(r)?r:0}function we(e,t){let n=t.trim().toLowerCase(),r=e.fields.find(e=>e.name.toLowerCase()===n);return r?ye(e,r.id):[]}function g(e){return Number.isFinite(e)?String(Number(e.toFixed(8))):`Formula error: not a number`}function Te(e){return e.toLowerCase().replace(/\b[a-z]/g,e=>e.toUpperCase())}function Ee(e,t,n,r){if(!e)return[];let i=r.trim().toLowerCase(),a=e.schema.relationships.find(e=>e.fromTableId===t.id&&e.name.toLowerCase()===i),o=a?e.schema.tables.find(e=>e.id===a.toTableId):void 0;return a&&o?_e(a,t,n,o):[]}function De(e,t,n,r,i){if(!e)return``;let a=e.schema.relationships.find(e=>e.fromTableId===t.id&&e.name.toLowerCase()===r.trim().toLowerCase()),o=a?e.schema.tables.find(e=>e.id===a.toTableId):void 0,s=Ee(e,t,n,r)[0],c=o?.fields.find(e=>e.name.toLowerCase()===i.trim().toLowerCase());return s&&c?String(s.values[c.id]??``):``}function Oe(e,t,n,r){let i=e.trim();if(!i)return``;let a=i.match(/^([A-Z_]+)\((.*)\)$/i);if(!a)return`Formula error: use a function like FIELD(Name)`;let o=a[1].toUpperCase(),s=xe(a[2]),c=s[0]??``;if(o===`FIELD`)return Ce(t,n,c);if(o===`JOIN`)return s.map(e=>m(t,n,e)).join(``);if(o===`UPPER`)return m(t,n,c).toUpperCase();if(o===`LOWER`)return m(t,n,c).toLowerCase();if(o===`TITLECASE`)return Te(m(t,n,c));if(o===`TRIM`)return m(t,n,c).trim();if(o===`LENGTH`)return String(m(t,n,c).length);if(o===`CONTAINS`)return m(t,n,c).toLowerCase().includes(m(t,n,s[1]??``).toLowerCase())?`Yes`:`No`;if(o===`IF_EMPTY`)return m(t,n,c).trim()?m(t,n,c):m(t,n,s[1]??``);if(o===`LOOKUP`)return De(r,t,n,Se(c)??c,Se(s[1]??``)??s[1]??``);if(o===`COUNT_RELATED`)return String(Ee(r,t,n,Se(c)??c).length);if(o===`ADD`)return g(s.reduce((e,r)=>e+h(t,n,r),0));if(o===`SUBTRACT`)return g(s.slice(1).reduce((e,r)=>e-h(t,n,r),h(t,n,c)));if(o===`MULTIPLY`)return g(s.reduce((e,r)=>e*h(t,n,r),1));if(o===`DIVIDE`){let e=h(t,n,s[1]??``);return e===0?`Formula error: divide by zero`:g(h(t,n,c)/e)}if(o===`ROUND`){let e=Math.max(0,Math.min(6,Math.round(h(t,n,s[1]??`"0"`))));return String(Number(h(t,n,c).toFixed(e)))}if([`SUM`,`AVERAGE`,`MIN`,`MAX`,`COUNT`].includes(o)){let e=we(t,c);return o===`SUM`?g(e.reduce((e,t)=>e+t,0)):o===`AVERAGE`?g(e.length?e.reduce((e,t)=>e+t,0)/e.length:0):o===`MIN`?g(e.length?Math.min(...e):0):o===`MAX`?g(e.length?Math.max(...e):0):String(e.length)}return`Formula error: ${o} is not supported`}function _(e){return e==null?``:String(e)}function ke(e,t){let n=t.query.trim();if(!n)return e.records;let r=n.toLowerCase();return e.records.filter(n=>(t.fieldId===`all`?e.fields.map(e=>e.id):[t.fieldId]).some(e=>_(n.values[e]).toLowerCase().includes(r)))}function Ae(e,t){let n=Number(e),r=Number(t);return e!==``&&t!==``&&!Number.isNaN(n)&&!Number.isNaN(r)?n-r:e.localeCompare(t,void 0,{numeric:!0,sensitivity:`base`})}function je(e,t){return t.length?[...e].sort((e,n)=>{for(let r of t){let t=_(e.values[r.fieldId]).trim(),i=_(n.values[r.fieldId]).trim();if(t===``&&i!==``)return 1;if(t!==``&&i===``)return-1;let a=Ae(t,i)*(r.direction===`asc`?1:-1);if(a!==0)return a}return 0}):e}function Me(e,t){let n=_(e.values[t.fieldId]),r=n.trim().toLowerCase(),i=t.value.trim().toLowerCase(),a=Number(n),o=Number(t.value),s=n.trim()!==``&&t.value.trim()!==``&&!Number.isNaN(a)&&!Number.isNaN(o);switch(t.operator){case`contains`:return r.includes(i);case`equals`:return s?a===o:r===i;case`startsWith`:return r.startsWith(i);case`endsWith`:return r.endsWith(i);case`greaterThan`:return s?a>o:r>i;case`lessThan`:return s?a<o:r<i;case`between`:{let e=Number(t.value),n=Number(t.value2);return!Number.isNaN(e)&&!Number.isNaN(n)&&!Number.isNaN(a)?a>=Math.min(e,n)&&a<=Math.max(e,n):r>=i&&r<=(t.value2??``).trim().toLowerCase()}case`isEmpty`:return n.trim()===``;case`isNotEmpty`:return n.trim()!==``;default:return!0}}function Ne(e,t){return!t||t.rules.length===0?e:e.filter(e=>t.match===`all`?t.rules.every(t=>Me(e,t)):t.rules.some(t=>Me(e,t)))}function Pe(e,t){let n=new Map;return e.records.forEach(e=>{let r=_(e.values[t]).trim().toLowerCase();r&&n.set(r,(n.get(r)??0)+1)}),e.records.filter(e=>{let r=_(e.values[t]).trim().toLowerCase();return r?(n.get(r)??0)>1:!1})}function Fe(e,t){return e.records.filter(e=>!_(e.values[t]).trim())}function Ie(e,t){if(!t.find)return[];let n=t.caseSensitive?`g`:`gi`,r=t.find.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=t.wholeWord?`\\b${r}\\b`:r,a=new RegExp(i,n),o=new Set(t.recordIds??e.records.map(e=>e.id)),s=[];return e.records.forEach(e=>{o.has(e.id)&&t.fieldIds.forEach(n=>{let r=_(e.values[n]),i=r.replace(a,t.replacement);i!==r&&s.push({recordId:e.id,fieldId:n,before:r,after:i})})}),s}function Le(e,t){if(!t.find)return{table:e,count:0};let n=t.caseSensitive?`g`:`gi`,r=t.find.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),i=t.wholeWord?`\\b${r}\\b`:r,a=new RegExp(i,n),o=new Set(t.recordIds??e.records.map(e=>e.id)),s=0,c=e.records.map(e=>{if(!o.has(e.id))return e;let n=!1,r={...e.values};return t.fieldIds.forEach(e=>{let i=_(r[e]),o=i.replace(a,()=>(s+=1,t.replacement));o!==i&&(n=!0,r[e]=o)}),n?{...e,updatedAt:new Date().toISOString(),values:r}:e});return{table:{...e,records:c},count:s}}var Re={email:/^[^\s@]+@[^\s@]+\.[^\s@]+$/,url:/^(https?:\/\/)?[^\s.]+\.[^\s]{2,}$/,phone:/^[+()\d][\d\s().-]{5,}$/};function ze(e){return e==null?``:String(e)}function Be(e,t,n,r){let i=ze(t).trim();if(i===``)return e.required?`This field is required.`:``;if([`number`,`currency`,`percent`,`rating`].includes(e.type)){let t=Number(i);if(Number.isNaN(t))return`Enter a number.`;if(e.min!=null&&t<e.min)return`Must be at least ${e.min}.`;if(e.max!=null&&t>e.max)return`Must be at most ${e.max}.`}if([`text`,`longText`,`link`].includes(e.type)&&e.pattern&&e.pattern!==`none`){if(e.pattern===`custom`){if(e.customPattern)try{if(!new RegExp(e.customPattern).test(i))return`Does not match the required format.`}catch{}}else if(!Re[e.pattern].test(i))return`Enter a valid ${e.pattern}.`}return e.unique&&n&&n.records.some(t=>t.id!==r&&ze(t.values[e.id]).trim().toLowerCase()===i.toLowerCase())?`This value is already used in another record.`:``}function Ve(e){let t=[];return e.fields.forEach(n=>{[`calculation`,`autoNumber`,`createdAt`,`updatedAt`,`image`].includes(n.type)||e.records.forEach(r=>{let i=Be(n,r.values[n.id],e,r.id);i&&t.push({record:r,field:n,message:i})})}),t}function v(e,t,n,r,i,a){return{id:e,title:t,gradeBand:n,goal:r,table:se(t,i),reflectionQuestions:a}}var He=[v(`classroom-library`,`Classroom Library Catalog`,`Grades 3-8`,`Track books, genres, reading levels, and recommendations.`,`Title,Author,Genre,Pages,Who would enjoy it?
...
Apollo 11 mission,NASA,1969,Space exploration,First humans walked on the Moon`,[`How should the exhibit be grouped?`,`What field would help visitors understand the item?`])];function Ue(e){let t=e.table.fields.map(e=>({...e,id:`${e.id}_${Date.now().toString(36)}`})),n=e.table.records.map(n=>r(t,Object.fromEntries(e.table.fields.map((e,r)=>[t[r].id,n.values[e.id]??``]))));return{...e.table,id:`table_${e.id}_${Date.now().toString(36)}`,fields:t,records:n}}var We=`drawsplat.language`,Ge=[{code:`en`,label:`English`,dir:`ltr`,htmlLang:`en`},{code:`es`,label:`Español`,dir:`ltr`,htmlLang:`es`},{code:`vi`,label:`Tiếng Việt`,dir:`ltr`,htmlLang:`vi`},{code:`ar`,label:`العربية`,dir:`rtl`,htmlLang:`ar`},{code:`zh`,label:`中文`,dir:`ltr`,htmlLang:`zh`},{code:`uh`,label:`हिन्दी / اردو`,dir:`ltr`,htmlLang:`hi`}],Ke={es:{New:`Nuevo`,"Save JSON":`Guardar JSON`,"Open JSON":`Abrir JSON`,"Export CSV":`Exportar CSV`,File:`Archivo`,Edit:`Editar`,Data:`Datos`,Layout:`Diseño`,Tools:`Herramientas`,View:`Vista`,Teacher:`Docente`,Help:`Ayuda`,Title:`Título`,Search:`Buscar`,In:`En`,"All fields":`Todos los campos`,Sort:`Ordenar`,"Choose field":`Elegir campo`,"New field":`Campo nuevo`,"Field name":`Nombre del campo`,Type:`Tipo`,"Add field":`Agregar campo`,"Add record":`Agregar registro`,Table:`Tabla`,Form:`Formulario`,Cards:`Tarjetas`,Gallery:`Galería`,Labels:`Etiquetas`,Report:`Informe`,"Upload image":`Subir imagen`,"No image yet":`Sin imagen todavía`},vi:{New:`Mới`,"Save JSON":`Lưu JSON`,"Open JSON":`Mở JSON`,"Export CSV":`Xuất CSV`,File:`Tệp`,Edit:`Sửa`,Data:`Dữ liệu`,Layout:`Bố cục`,Tools:`Công cụ`,View:`Xem`,Teacher:`Giáo viên`,Help:`Trợ giúp`,Title:`Tiêu đề`,Search:`Tìm`,Sort:`Sắp xếp`,Table:`Bảng`,Form:`Biểu mẫu`,Cards:`Thẻ`,Gallery:`Thư viện ảnh`,Labels:`Nhãn`,Report:`Báo cáo`},ar:{New:`جديد`,"Save JSON":`حفظ JSON`,"Open JSON":`فتح JSON`,"Export CSV":`تصدير CSV`,File:`ملف`,Edit:`تحرير`,Data:`بيانات`,Layout:`تخطيط`,Tools:`أدوات`,View:`عرض`,Teacher:`المعلم`,Help:`مساعدة`,Title:`العنوان`,Search:`بحث`,Sort:`فرز`,Table:`جدول`,Form:`نموذج`,Cards:`بطاقات`,Gallery:`معرض`,Labels:`ملصقات`,Report:`تقرير`},zh:{New:`新建`,"Save JSON":`保存 JSON`,"Open JSON":`打开 JSON`,"Export CSV":`导出 CSV`,File:`文件`,Edit:`编辑`,Data:`数据`,Layout:`布局`,Tools:`工具`,View:`视图`,Teacher:`教师`,Help:`帮助`,Title:`标题`,Search:`搜索`,Sort:`排序`,Table:`表格`,Form:`表单`,Cards:`卡片`,Gallery:`图库`,Labels:`标签`,Report:`报告`},uh:{New:`नया`,File:`फ़ाइल`,Edit:`संपादन`,Data:`डेटा`,Layout:`लेआउट`,Tools:`औज़ार`,View:`दृश्य`,Teacher:`शिक्षक`,Help:`सहायता`,Search:`खोज`,Table:`तालिका`,Form:`फ़ॉर्म`,Cards:`कार्ड`,Gallery:`गैलरी`,Labels:`लेबल`,Report:`रिपोर्ट`}},qe=document.querySelector(`#app`);if(!qe)throw Error(`ListSplatTM app root was not found.`);var y=qe,b=fe()??a(),x=b.schema.tables[0].id,S=b.schema.tables[0].records[0]?.id??``,C=`table`,Je=`Saved locally`,w=``,T=`all`,E=[],D=null,O={match:`all`,rules:[]},k=[],Ye=``,A=new Set,j=null,M=[],N=new Set,P=`none`,Xe=``,F=`Tip: Start with one table, then add relationships when your project needs them.`,I=[],L=[],Ze=``,Qe=null,R=[],$e=x,et=b.schema.tables[1]?.id??x,z=null,tt=``,B=rt();function V(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}function nt(e){let t=(e||``).toLowerCase();return t.startsWith(`es`)?`es`:t.startsWith(`vi`)?`vi`:t.startsWith(`ar`)?`ar`:t.startsWith(`zh`)?`zh`:t===`uh`||t.startsWith(`ur`)||t.startsWith(`hi`)?`uh`:`en`}function rt(){let e=new URLSearchParams(window.location.search);try{return nt(e.get(`lang`)||localStorage.getItem(We)||navigator.language)}catch{return nt(e.get(`lang`)||navigator.language)}}function it(e){return Ge.map(({code:t,label:n})=>`<option value="${t}"${t===e?` selected`:``}>${n}</option>`).join(``)}function H(e){return B===`en`?e:Ke[B][e]??e}function at(){let e=Ge.find(e=>e.code===B)??Ge[0];document.documentElement.lang=e.htmlLang,document.documentElement.dir=e.dir}function U(){return b.schema.tables.find(e=>e.id===x)??b.schema.tables[0]}function W(e){let t=ke(e,{query:w,fieldId:T});return t=Ne(t,D),N.size>0&&(t=t.filter(e=>N.has(e.id))),je(t,E.filter(t=>e.fields.some(e=>e.id===t.fieldId)))}function ot(){return!!w||!!(D&&D.rules.length)||N.size>0}function st(){w=``,D=null,N=new Set}function ct(e){e.records.some(e=>e.id===S)||(S=e.records[0]?.id??``)}function G(e){b=e,ct(U()),de(b),Je=`Saved locally`,Q()}function K(e){I=[{label:e,project:structuredClone(b)},...I].slice(0,25),L=[]}function lt(e,t){let n=`${e}:${t}`;Ze!==n&&(K(`edit ${U().fields.find(e=>e.id===t)?.name??`cell`}`),Ze=n,ut())}function ut(){let e=y.querySelector(`[data-action="undo-change"]`),t=y.querySelector(`[data-action="redo-change"]`);e&&(e.disabled=I.length===0),t&&(t.disabled=L.length===0)}function dt(e){b=e,x=b.schema.tables.some(e=>e.id===x)?x:b.schema.tables[0].id,ct(U()),de(b),Q()}function ft(){let e=I[0];if(!e){F=`Nothing to undo yet.`,Q();return}L=[{label:e.label,project:structuredClone(b)},...L].slice(0,25),I=I.slice(1),F=`Undid ${e.label}.`,dt(e.project)}function pt(){let e=L[0];if(!e){F=`Nothing to redo.`,Q();return}I=[{label:e.label,project:structuredClone(b)},...I].slice(0,25),L=L.slice(1),F=`Redid ${e.label}.`,dt(e.project)}function q(e){x=e.id,G(ne(b,e))}function mt(){document.querySelectorAll(`.menu[open]`).forEach(e=>{e.open=!1})}function ht(e){G({...b,updatedAt:new Date().toISOString(),metadata:{...b.metadata,title:e||`Untitled Database`}})}function gt(){pe(`${b.metadata.title||`listsplat-project`}.listsplat.json`,JSON.stringify(b,null,2),`application/json`)}function _t(){pe(`${U().name}.csv`,le(U()),`text/csv;charset=utf-8`)}function vt(){let e=U(),t=W(e),n=`<!doctype html>
<html lang="en">
...
<tbody>${t.map(t=>`<tr>${e.fields.map(n=>`<td>${V(Y(e,t,n.id))}</td>`).join(``)}</tr>`).join(``)}</tbody></table></body></html>`;pe(`${b.metadata.title||`listsplat-report`}.html`,n,`text/html;charset=utf-8`)}function yt(){let e=b.schema.tables.map(e=>{let t=At(e),n=t.reduce((e,t)=>e+t.missing,0),r=t.reduce((e,t)=>e+t.duplicates,0);return`
        <section>
          <h2>${V(e.name)}</h2>
      ...
      `}).join(``),t=b.schema.relationships.length?`<ul>${b.schema.relationships.map(e=>`<li>${V(e.name)}: ${V(ve(b,e))}</li>`).join(``)}</ul>`:`<p>No relationships have been created yet.</p>`,n=b.teacher.notes.length?`<ul>${b.teacher.notes.map(e=>`<li>${V(e)}</li>`).join(``)}</ul>`:`<p>No teacher notes yet.</p>`,r=`<!doctype html>
<html lang="en">
...
<body>
  ...
  ${e}
</body></html>`;pe(`${b.metadata.title||`listsplat`}-project-packet.html`,r,`text/html;charset=utf-8`)}function bt(e){e.text().then(e=>{let t=JSON.parse(e);ie(t),x=t.schema.tables[0].id,S=t.schema.tables[0].records[0]?.id??``,G(t)}).catch(e=>{window.alert(e instanceof Error?e.message:`Could not open this ListSplatTM file.`)})}function xt(e){e.text().then(t=>{let n=se(e.name.replace(/\.csv$/i,``),t);z=n,tt=e.name;let r=U();M=n.fields.map(e=>{let t=n.records.slice(0,12).map(t=>String(t.values[e.id]??``)),i=r.fields.find(t=>t.name.trim().toLowerCase()===e.name.trim().toLowerCase());return{header:e.name,action:i?`existing`:`new`,type:Ln(t),fieldId:i?.id??``}}),P=`csvImport`,F=`Previewing ${n.records.length} CSV record${n.records.length===1?``:`s`} from ${e.name}.`,Q()})}function St(e){if(!z){P=`none`;return}Rn();let i=z;if(K(`CSV import`),e===`new`){let e=M.filter(e=>e.action!==`skip`).map((e,t)=>{let r=i.fields[M.indexOf(e)];return{field:n(e.header||`Field ${t+1}`,e.type),sourceFieldId:r.id}}),a=i.records.map(t=>r(e.map(e=>e.field),Object.fromEntries(e.map(e=>[e.field.id,u(t.values[e.sourceFieldId],e.field.type).value])))),o={id:t(`table`),name:i.name,fields:e.map(e=>e.field),records:a.length?a:[r(e.map(e=>e.field))]};x=o.id,S=o.records[0]?.id??``,z=null,st(),E=[],A=new Set,P=`none`,F=`Imported ${o.records.length} records from ${tt}.`,G({...b,updatedAt:new Date().toISOString(),schema:{...b.schema,tables:[...b.schema.tables,o]},layouts:[...b.layouts,{id:t(`layout`),name:`${o.name} Table`,tableId:o.id,mode:`table`,locked:!1},{id:t(`layout`),name:`${o.name} Form`,tableId:o.id,mode:`form`,locked:!1}]});return}let a=U();M.forEach((e,t)=>{if(e.action===`new`){let r=n(e.header||`Field ${t+1}`,e.type);a={...a,fields:[...a.fields,r]},e.fieldId=r.id}});let o=new Map(a.fields.map(e=>[e.id,e])),s=i.records.map(e=>r(a.fields,Object.fromEntries(M.filter(e=>e.action!==`skip`&&e.fieldId&&o.has(e.fieldId)).map((t,n)=>{let r=i.fields[M.indexOf(t)],a=o.get(t.fieldId);return[t.fieldId,u(e.values[r.id],a.type,a.options).value]}))));z=null,P=`none`,F=`Appended ${s.length} CSV record${s.length===1?``:`s`} to ${a.name}.`,q({...a,records:[...a.records,...s]})}function Ct(e){let t=He.find(t=>t.id===e);if(!t)return;let n=Ue(t);K(`template load`),x=n.id,S=n.records[0]?.id??``,F=`Loaded ${t.title}.`,G({...b,metadata:{...b.metadata,title:t.title},schema:{...b.schema,tables:[...b.schema.tables,n]},teacher:{...b.teacher,notes:t.reflectionQuestions}})}function J(e,t){return`
    <details class="menu">
  ...
  `}function wt(e=`text`){return[[`text`,`Short text`],[`longText`,`Long text`],[`number`,`Number`],[`currency`,`Currency`],[`percent`,`Percent`],[`date`,`Date`],[`checkbox`,`Checkbox`],[`rating`,`Rating`],[`choice`,`Choice`],[`image`,`Image`],[`link`,`Link`],[`calculation`,`Calculation`],[`autoNumber`,`Auto number`],[`createdAt`,`Created time`],[`updatedAt`,`Updated time`]].map(([t,n])=>`<option value="${t}" ${e===t?`selected`:``}>${n}</option>`).join(``)}function Y(e,t,n){let r=e.fields.find(e=>e.id===n);return r?.type===`calculation`&&r.formula?Oe(r.formula,e,t,b):t.values[n]??``}function Tt(e,t){if(t===``||t==null)return``;if(!e)return String(t);let n=typeof t==`number`?t:Number(t);return e.type===`currency`&&Number.isFinite(n)?n.toLocaleString(void 0,{style:`currency`,currency:`USD`}):e.type===`percent`&&Number.isFinite(n)?`${n.toLocaleString()}%`:e.type===`number`&&Number.isFinite(n)?n.toLocaleString():e.type===`checkbox`?t===!0||t===`true`?`Yes`:`No`:String(t)}function X(){return b.layouts.find(e=>e.tableId===x&&e.mode===C)}function Et(e){return!!e}function Z(e){let t=new Set(X()?.hiddenFieldIds??[]);return Dt(e).filter(e=>!t.has(e.id))}function Dt(e){let t=X()?.fieldOrder??e.fields.map(e=>e.id),n=new Map(e.fields.map(e=>[e.id,e]));return[...t.map(e=>n.get(e)).filter(Et),...e.fields.filter(e=>!t.includes(e.id))].filter(e=>e&&!e.hidden)}function Ot(e){return e.fields.filter(e=>e.type===`calculation`)}function kt(e){return Ot(e).reduce((t,n)=>n.formula?t+e.records.filter(t=>String(Oe(n.formula??``,e,t,b)).startsWith(`Formula error:`)).length:t,0)}function At(e){return e.fields.filter(e=>!e.hidden&&![`image`,`autoNumber`,`createdAt`,`updatedAt`,`calculation`].includes(e.type)).map(t=>({field:t,missing:Fe(e,t.id).length,duplicates:Pe(e,t.id).length}))}function jt(e){return Z(e).filter(e=>e.type===`image`)}function Mt(e,t){let n=jt(e)[0];return n?String(Y(e,t,n.id)??``):``}function Nt(e){let t=X();t&&G({...b,updatedAt:new Date().toISOString(),layouts:b.layouts.map(n=>n.id===t.id?{...n,...e}:n)})}function Pt(e,t){let n=e.fields.find(e=>!e.hidden)??e.fields[0],r=n?Y(e,t,n.id):``;return String(r||`Untitled record`)}function Ft(e,t,n,r){let i=e.fields.find(e=>e.id===n),a=Y(e,t,n),o=`aria-label="${V(i?.name??`Field`)}, record ${r+1}" data-record-id="${t.id}" data-field-id="${n}"`,s=i&&![`checkbox`,`image`,`calculation`,`autoNumber`,`createdAt`,`updatedAt`].includes(i.type)?Be(i,a,e,t.id):``,c=s?`cell-input cell-invalid`:`cell-input`,l=s?` title="${V(s)}"`:``;if(i?.type===`checkbox`)return`<input class="cell-checkbox" type="checkbox" ${o} ${a===!0||a===`true`?`checked`:``}>`;if(i?.type===`link`){let e=String(a??``),t=/^https?:\/\//i.test(e)?e:e?`https://${e}`:``;return`<div class="link-cell"><input class="${c}" type="url" ${o}${l} value="${V(e)}" placeholder="https://…">${t?`<a class="link-open" href="${V(t)}" target="_blank" rel="noopener" title="Open link" aria-label="Open link">↗</a>`:``}</div>`}if(i?.type===`image`){let e=String(a??``);return`
    ...
    `}if(i?.type===`rating`)return`<input class="${c}" type="number" min="0" max="5" step="1" ${o}${l} value="${V(a)}">`;if(i?.type===`choice`){let e=i.options?.length?i.options:[`Yes`,`No`];return`<select class="${c}" ${o}${l}><option value=""${a===``?` selected`:``}>—</option>${e.map(e=>`<option value="${V(e)}" ${String(a)===e?`selected`:``}>${V(e)}</option>`).join(``)}</select>`}if(i?.type===`autoNumber`||i?.type===`createdAt`||i?.type===`updatedAt`)return`<output class="calc-output">${V(a)}</output>`;if(i?.type===`longText`)return`<textarea class="${c}" ${o}${l}>${V(a)}</textarea>`;if(i?.type===`date`)return`<input class="${c}" type="date" ${o}${l} value="${V(a)}">`;if(i?.type===`number`||i?.type===`currency`||i?.type===`percent`){let e=i.type===`currency`?`<span class="cell-affix">$</span>`:``,t=i.type===`percent`?`<span class="cell-affix">%</span>`:``;return`<span class="num-cell">${e}<input class="${c}" type="number" step="any" ${o}${l} value="${V(a)}">${t}</span>`}return i?.type===`calculation`?`<output class="calc-output">${V(a)}</output>`:`<input class="${c}" ${o}${l} value="${V(a)}">`}function It(e){return`
    <div class="table-tabs">
      ${b.schema.tables.map(t=>`<button type="button" class="table-tab ${t.id===e.id?`active`:``}" data-table-id="${t.id}">${V(t.name)}</button>`).join(``)}
    </div>
  `}function Lt(e,t){if(t.length===0){let e=ot();return`
      ...
      <table class="data-grid">
        <thead>
          <tr>
            ...
            ${n.map(e=>`
                  <th class="col-head" data-col-field="${e.id}" draggable="true" style="${Rt(e.id)}">
        ...
        <tbody>
          ${t.map((t,r)=>`
                <tr class="${t.id===S?`active-row`:``}${A.has(t.id)?` selected-row`:``}" data-record-row="${t.id}">
                  ...
                  ${n.map(n=>`<td style="${Rt(n.id)}">${Ft(e,t,n.id,r)}</td>`).join(``)}
  ...
  `}function Rt(e){let t=X()?.columnWidths?.[e];return t?`width:${t}px;min-width:${t}px;`:``}function zt(e){let t=e.records.find(e=>e.id===S)??e.records[0];if(!t)return`<div class="empty-panel">Add a record to use form view.</div>`;let n=b.schema.relationships.filter(t=>t.fromTableId===e.id).map(n=>{let r=b.schema.tables.find(e=>e.id===n.toTableId),i=r?_e(n,e,t,r):[];return`
  ...
  `}function Bt(e,t){let n=(t,n)=>{let r=Y(e,n,t.id);if(t.type===`image`){let e=String(r??``);return`
        <figure class="card-image-field">
          ${e?`<img src="${V(e)}" alt="">`:`<span>No image yet</span>`}
          <figcaption>${V(t.name)}</figcaption>
        </figure>
      `}if(t.type===`link`&&String(r??``)){let e=String(r),n=/^https?:\/\//i.test(e)?e:`https://${e}`;return`<p><strong>${V(t.name)}</strong><a href="${V(n)}" target="_blank" rel="noopener">${V(e)}</a></p>`}return`<p><strong>${V(t.name)}</strong><span>${V(Tt(t,r))}</span></p>`};return`
    <div class="cards-view ${C===`gallery`?`gallery-view`:``}">
      ${t.map(t=>{let r=Mt(e,t);return`
    ...
    <div class="labels-view">
      ${t.map(t=>`
            <article class="print-label">
              ${Z(e).slice(0,4).map(n=>`<p><strong>${V(n.name)}:</strong> ${V(Tt(n,Y(e,t,n.id)))}</p>`).join(``)}
            </article>
          `).join(``)}
    </div>
  `}function Ht(e,t){let n=be(e);return`
  ...
  `}function Ut(e){let t=W(e),n={table:`Table: spreadsheet-like rows and columns for fast data entry.`,form:`Form: focus on one record at a time.`,cards:`Cards: compact text-first record cards for browsing.`,gallery:`Gallery: image-first cards for collections and exhibits.`,labels:`Labels: printable small cards or shelf labels.`,report:`Report: printable table with title and summaries.`},r=C===`form`?zt(e):C===`cards`||C===`gallery`?Bt(e,t):C===`labels`?Vt(e,t):C===`report`?Ht(e,t):Lt(e,t);return`
  ...
  `}function Wt(){let e=[];if(w&&e.push(`<span class="chip">Search: “${V(w)}”</span>`),D&&D.rules.length){let t=D.match===`all`?` AND `:` OR `,n=D.rules.map(e=>`${Cn(e.fieldId)} ${wn(e.operator)}${e.operator===`isEmpty`||e.operator===`isNotEmpty`?``:` `+e.value}${e.operator===`between`?`–`+(e.value2??``):``}`).join(t);e.push(`<button type="button" class="chip chip-button" data-action="find" title="Edit find">Find: ${V(n)}</button>`)}return N.size&&e.push(`<span class="chip">${N.size} highlighted</span>`),E.filter(e=>U().fields.some(t=>t.id===e.fieldId)).forEach(t=>{e.push(`<button type="button" class="chip chip-button" data-action="sort-dialog" title="Edit sort">Sort: ${V(Cn(t.fieldId))} ${t.direction===`asc`?`↑`:`↓`}</button>`)}),e.length?`<div class="filter-chips">${e.join(``)}${ot()?`<button type="button" class="chip chip-clear" data-action="clear-find">Clear find</button>`:``}${E.length?`<button type="button" class="chip chip-clear" data-action="sort-dialog">Edit sort</button>`:``}</div>`:``}function Gt(e){let t=Nn(e).length;return t===0||C===`form`?``:`
  ...
  `}function Kt(e){let t=be(e),n=e.records.find(e=>e.id===S)??e.records[0],r=n?b.schema.relationships.filter(t=>t.fromTableId===e.id).map(t=>{let r=b.schema.tables.find(e=>e.id===t.toTableId),i=r?_e(t,e,n,r).length:0;return`
  ...
  `}function qt(){let e=b.schema.tables,t=b.schema.relationships,n=t=>e.find(e=>e.id===t)?.name??`table`,r=(t,n)=>e.find(e=>e.id===t)?.fields.find(e=>e.id===n)?.name??`field`,i=new Set(t.flatMap(e=>[e.fromTableId,e.toTableId]));return`<div class="rel-diagram"><div class="rel-boxes">${e.map(e=>`
      ...
      `).join(``)}</div><div class="rel-links">${t.length?t.map(e=>`
          ...
          `).join(``):`<p class="rel-empty">No links yet. Create one below to connect two tables.</p>`}</div></div>`}function Jt(e,t){let n=[`number`,`currency`,`percent`,`rating`].includes(t),r=[`text`,`longText`,`link`].includes(t);return[`calculation`,`autoNumber`,`createdAt`,`updatedAt`,`image`].includes(t)?``:`
  ...
  `}function Xt(e){let t=t=>e.fields.map(e=>`<option value="${e.id}" ${e.id===t?`selected`:``}>${V(e.name)}</option>`).join(``),n=O.rules.map((e,n)=>{let r=Sn.find(t=>t.value===e.operator)??Sn[0];return`
        <div class="find-rule" data-rule-index="${n}">
          <select data-find-field aria-label="Field">${t(e.fieldId)}</select>
          <select data-find-op aria-label="Condition">${Sn.map(t=>`<option value="${t.value}" ${t.value===e.operator?`selected`:``}>${V(t.label)}</option>`).join(``)}</select>
  ...
  `}function Zt(e){let t=t=>e.fields.map(e=>`<option value="${e.id}" ${e.id===t?`selected`:``}>${V(e.name)}</option>`).join(``);return`
    <div class="modal-backdrop">
  ...
  `}function $t(e){let t=Nn(e).length;return`
    <div class="modal-backdrop">
  ...
  `}function en(e){if(P===`none`)return``;if(P===`find`)return Xt(e);if(P===`sort`)return Zt(e);if(P===`views`)return Qt();if(P===`bulkFill`)return $t(e);if(P===`replace`){let t=R.slice(0,8);return`
      <div class="modal-backdrop">
        <section class="modal" role="dialog" aria-modal="true" aria-label="Replace values">
          ...
          ${R.length?`<div class="replace-preview"><strong>${R.length} change${R.length===1?``:`s`} ready</strong>${t.map(t=>{let n=e.records.find(e=>e.id===t.recordId),r=e.fields.find(e=>e.id===t.fieldId);return`<p><span>${V(n?Pt(e,n):`Record`)} / ${V(r?.name??`Field`)}</span><del>${V(t.before)}</del><ins>${V(t.after)}</ins></p>`}).join(``)}</div>`:``}
          <div class="modal-actions">
    ...
    `}if(P===`field`){let t=e.fields.find(e=>e.id===Xe)??e.fields[0],n=Ye||t.type;return`
      <div class="modal-backdrop">
        <section class="modal" role="dialog" aria-modal="true" aria-label="Field settings">
          ...
          <label>Type <select data-field-type>${wt(n)}</select></label>
          ${Yt(e,t,n)}
    ...
    `}if(P===`layout`){let t=X(),n=Dt(e),r=new Set(t?.hiddenFieldIds??[]);return`
      <div class="modal-backdrop">
    ...
    `}if(P===`csvImport`&&z){let t=z.records.slice(0,4),n=t=>e.fields.map(e=>`<option value="${e.id}" ${e.id===t?`selected`:``}>${V(e.name)}</option>`).join(``),r=M.map((e,t)=>`
          <div class="csv-map-row" data-map-index="${t}">
            ...
            <select data-map-type aria-label="Type for ${V(e.header)}" ${e.action===`new`?``:`hidden`}>${wt(e.type)}</select>
      ...
      <div class="modal-backdrop">
        <section class="modal wide-modal" role="dialog" aria-modal="true" aria-label="CSV import">
          <h2>Import CSV</h2>
          <p>${V(tt)} has ${z.fields.length} column${z.fields.length===1?``:`s`} and ${z.records.length} row${z.records.length===1?``:`s`}. Choose how each column maps.</p>
    ...
    `;if(P===`relationship`){let t=b.schema.tables.find(e=>e.id===$e)??e,n=b.schema.tables.find(e=>e.id===et)??e,r=t.fields.map(e=>`<option value="${t.id}:${e.id}">${V(e.name)}</option>`).join(``),i=n.fields.map(e=>`<option value="${n.id}:${e.id}">${V(e.name)}</option>`).join(``);return`
      <div class="modal-backdrop">
        <section class="modal wide-modal" role="dialog" aria-modal="true" aria-label="Relationships">
          ...
          ${b.schema.relationships.length?`<div class="relationship-list">${b.schema.relationships.map(e=>`<p><strong>${V(e.name)}</strong><br>${V(ve(b,e))}</p>`).join(``)}</div>`:`<p>No relationships yet. Add a second table first for the most useful results.</p>`}
          <div class="modal-actions">
    ...
    `}if(P===`quality`){let t=At(e),n=kt(e),r=t.reduce((e,t)=>e+t.missing,0),i=t.reduce((e,t)=>e+t.duplicates,0),a=Ve(e).length;return`
      <div class="modal-backdrop">
...
`))}</textarea></label>
  ...
  `}function Q(){let e=U();ct(e),at();let t=b.teacher.studentView;if(y.innerHTML=`
    <header class="app-header">
      ...
      <div class="quick-actions">
        <button type="button" class="button" data-action="undo-change"${I.length?``:` disabled`} title="Undo (Ctrl+Z)" aria-label="Undo">↶ ${V(H(`Undo`))}</button>
        <button type="button" class="button" data-action="redo-change"${L.length?``:` disabled`} title="Redo (Ctrl+Y)" aria-label="Redo">↷ ${V(H(`Redo`))}</button>
        ...
        <select id="languageSwitcher" class="lang-switcher" aria-label="Language">${it(B)}</select>
      </div>
    </header>
    <main class="listsplat-app">
      ...
      <section class="toolbar" aria-label="Database toolbar">
        ...
        <label>${V(H(`Type`))} <select data-new-field-type>${wt()}</select></label>
    ...
    ${en(e)}
  `,Ze=``,Qe){let e=Qe;Qe=null,mn(e.recordId,e.fieldId)}vn()}function tn(e){return e instanceof HTMLInputElement&&e.type===`checkbox`?e.checked:e instanceof HTMLInputElement&&e.type===`number`?e.value===``?``:Number(e.value):e.value}function nn(e){let t=e.dataset.recordId,n=e.dataset.fieldId;!t||!n||(b=ne(b,te(U(),t,n,tn(e))),de(b),Je=`Saved locally`)}function rn(e){return new Promise((t,n)=>{let r=new FileReader;r.onerror=()=>n(r.error),r.onload=()=>{let n=String(r.result??``);if(e.size<=35e4){t(n);return}let i=new Image;i.onerror=()=>t(n),i.onload=()=>{let e=1280,r=Math.max(i.width,i.height),a=r>e?e/r:1,o=Math.max(1,Math.round(i.width*a)),s=Math.max(1,Math.round(i.height*a)),c=document.createElement(`canvas`);c.width=o,c.height=s;let l=c.getContext(`2d`);if(!l){t(n);return}l.drawImage(i,0,0,o,s);let u=c.toDataURL(`image/jpeg`,.82);t(u.length<n.length?u:n)},i.src=n},r.readAsDataURL(e)})}function an(e,t,n,r){if(!n.type.startsWith(`image/`)){F=`That clipboard item is not an image.`,Q();return}rn(n).then(n=>{K(r),b=ne(b,te(U(),e,t,n)),de(b);let i=Math.round(n.length/1024);F=i>900?`Image saved (about ${i} KB). Very large pictures can slow autosave — a smaller image is fine for most projects.`:`Image saved in this field.`,Q()}).catch(()=>{F=`Could not read that image.`,Q()})}function on(){let e=U(),t=e.fields.find(e=>e.id===Xe);if(!t)return;let n=y.querySelector(`[data-field-name]`)?.value??t.name,r=y.querySelector(`[data-field-type]`)?.value??t.type,i=y.querySelector(`[data-field-description]`)?.value??``,a=y.querySelector(`[data-field-required]`)?.checked??!1,o=y.querySelector(`[data-field-hidden]`)?.checked??!1,s=y.querySelector(`[data-field-formula]`)?.value??``,c=(y.querySelector(`[data-field-options]`)?.value??``).split(`,`).map(e=>e.trim()).filter(Boolean),l=y.querySelector(`[data-field-unique]`)?.checked??!1,u=y.querySelector(`[data-field-min]`)?.value??``,p=y.querySelector(`[data-field-max]`)?.value??``,ee=u.trim()===``?void 0:Number(u),te=p.trim()===``?void 0:Number(p),ne=y.querySelector(`[data-field-pattern]`)?.value??`none`,re=y.querySelector(`[data-field-custom-pattern]`)?.value??``,ie=y.querySelector(`[data-field-default]`)?.value??``,ae=r!==t.type,oe=f(e,t.id,{name:n,type:r,description:i,required:a,hidden:o,formula:s,options:c,unique:l,min:ee,max:te,pattern:ne,customPattern:re,defaultValue:ie});ae&&![`calculation`,`autoNumber`,`createdAt`,`updatedAt`,`image`].includes(r)&&(oe=d(oe,t.id,r,c)),q(oe),P=`none`,F=ae?`Updated ${n} and converted values to ${r}.`:`Updated ${n}.`,Q()}function sn(){let e=y.querySelector(`[data-replace-find]`)?.value??``,t=y.querySelector(`[data-replace-with]`)?.value??``,n=y.querySelector(`[data-replace-field]`)?.value??U().fields[0]?.id,r=y.querySelector(`[data-replace-case-sensitive]`)?.checked??!1,i=y.querySelector(`[data-replace-whole-word]`)?.checked??!1,a=w?W(U()).map(e=>e.id):void 0;K(`replace`);let o=Le(U(),{fieldIds:[n],find:e,replacement:t,recordIds:a,caseSensitive:r,wholeWord:i});P=`none`,R=[],F=`Replaced ${o.count} value${o.count===1?``:`s`}.`,q(o.table)}function cn(){let e=y.querySelector(`[data-replace-find]`)?.value??``,t=y.querySelector(`[data-replace-with]`)?.value??``,n=y.querySelector(`[data-replace-field]`)?.value??U().fields[0]?.id,r=y.querySelector(`[data-replace-case-sensitive]`)?.checked??!1,i=y.querySelector(`[data-replace-whole-word]`)?.checked??!1,a=w?W(U()).map(e=>e.id):void 0;R=Ie(U(),{fieldIds:[n],find:e,replacement:t,recordIds:a,caseSensitive:r,wholeWord:i}),F=`Preview found ${R.length} change${R.length===1?``:`s`}.`,Q()}function ln(){let e=(y.querySelector(`[data-teacher-notes]`)?.value??``).split(`
`).map(e=>e.trim()).filter(Boolean);K(`teacher notes`),P=`none`,F=`Saved ${e.length} teacher note${e.length===1?``:`s`}.`,G({...b,updatedAt:new Date().toISOString(),teacher:{...b.teacher,notes:e}})}function un(e){let t=y.querySelector(e)?.value;if(!t)return null;let[n,r]=t.split(`:`);return n&&r?{tableId:n,fieldId:r}:null}function dn(){let e=y.querySelector(`[data-relationship-from-table]`)?.value??``,t=y.querySelector(`[data-relationship-to-table]`)?.value??``,n=un(`[data-relationship-from-field]`),r=un(`[data-relationship-to-field]`),i=y.querySelector(`[data-relationship-name]`)?.value??``;if(!e||!t||!n||!r){F=`Choose both tables and both match fields.`,Q();return}if(n.tableId!==e||r.tableId!==t){F=`Match fields must belong to the tables you chose.`,Q();return}K(`relationship create`);let a=he(i,e,n.fieldId,t,r.fieldId);F=`Created relationship: ${a.name}.`,G(ge(b,a))}function fn(){$e=y.querySelector(`[data-relationship-from-table]`)?.value??$e,et=y.querySelector(`[data-relationship-to-table]`)?.value??et,Q()}function pn(e){return window.CSS&&typeof CSS.escape==`function`?CSS.escape(e):e.replace(/["\\]/g,`\\$&`)}function mn(e,t){let n=y.querySelector(`.data-grid`);if(!n)return!1;let r=n.querySelector(`tr[data-record-row="${pn(e)}"]`);if(!r)return!1;let i=r.querySelector(`.cell-input[data-field-id="${pn(t)}"], .cell-checkbox[data-field-id="${pn(t)}"]`);return i||=r.querySelector(`.cell-input, .cell-checkbox`),i?(i.focus(),i instanceof HTMLInputElement&&i.type!==`checkbox`&&i.select(),!0):!1}function hn(e){K(`add record`);let t=l(U()),n=t.records.at(-1);n&&(S=n.id,Qe={recordId:n.id,fieldId:e}),q(t)}function gn(e,t,n,r){let i=Array.from(y.querySelectorAll(`.data-grid tbody tr[data-record-row]`)),a=i.findIndex(t=>t.dataset.recordRow===e),o=Z(U()).map(e=>e.id),s=o.indexOf(t);if(a<0||s<0)return;let c=a+n,l=s+r;if(r>0&&l>=o.length?(l=0,c=a+1):r<0&&l<0&&(l=o.length-1,c=a-1),c>=i.length){hn(o[l]??o[0]);return}c<0||mn(i[c].dataset.recordRow??e,o[l]??t)}function _n(){if(!j)return null;let e=W(U()).map(e=>e.id),t=Z(U()).map(e=>e.id),n=e.indexOf(j.anchor.r),r=e.indexOf(j.focus.r),i=t.indexOf(j.anchor.f),a=t.indexOf(j.focus.f);return n<0||r<0||i<0||a<0?null:{rows:e,cols:t,r1:Math.min(n,r),r2:Math.max(n,r),c1:Math.min(i,a),c2:Math.max(i,a)}}function vn(){y.querySelectorAll(`.data-grid td.cell-range`).forEach(e=>e.classList.remove(`cell-range`));let e=_n();if(e&&!((e.r2-e.r1+1)*(e.c2-e.c1+1)<=1))for(let t=e.r1;t<=e.r2;t+=1)for(let n=e.c1;n<=e.c2;n+=1)y.querySelector(`.data-grid [data-record-id="${pn(e.rows[t])}"][data-field-id="${pn(e.cols[n])}"]`)?.closest(`td`)?.classList.add(`cell-range`)}function yn(e){if(!j)return;let t=W(U()).map(e=>e.id),n=Z(U()).map(e=>e.id),r=t.indexOf(j.focus.r),i=n.indexOf(j.focus.f);r<0||i<0||(e===`ArrowUp`?r=Math.max(0,r-1):e===`ArrowDown`?r=Math.min(t.length-1,r+1):e===`ArrowLeft`?i=Math.max(0,i-1):e===`ArrowRight`&&(i=Math.min(n.length-1,i+1)),j={anchor:j.anchor,focus:{r:t[r],f:n[i]}},vn())}function bn(){let e=_n();if(!e||e.r2-e.r1===0&&e.c2-e.c1===0)return!1;let t=U(),n=new Map(t.records.map(e=>[e.id,e])),r=[];for(let i=e.r1;i<=e.r2;i+=1){let a=n.get(e.rows[i]);if(!a)continue;let o=[];for(let n=e.c1;n<=e.c2;n+=1)o.push(String(Y(t,a,e.cols[n])??``).replace(/\t/g,` `).replace(/\n/g,` `));r.push(o.join(`	`))}let i=r.join(`
`);navigator.clipboard?.writeText(i).catch(()=>void 0);let a=(e.r2-e.r1+1)*(e.c2-e.c1+1),o=y.querySelector(`.status-bar span:nth-last-child(2)`);return o&&(o.textContent=`Copied ${a} cells.`),!0}function xn(e,t,n){let i=U(),a=W(i),o=Z(i).map(e=>e.id),s=a.findIndex(e=>e.id===t),c=o.indexOf(n);if(s<0||c<0)return;let l=e.replace(/\r/g,``).replace(/\n$/,``).split(`
`).map(e=>e.split(`	`));K(`paste`);let d=new Map(i.records.map(e=>[e.id,e])),f=i.records.map(e=>e.id),p=0;l.forEach((e,t)=>{let n;if(s+t<a.length)n=a[s+t].id;else{let e=r(i.fields);d.set(e.id,e),f.push(e.id),n=e.id,p+=1}let l=d.get(n);if(!l)return;let ee={...l.values};e.forEach((e,t)=>{let n=o[c+t],r=n?i.fields.find(e=>e.id===n):void 0;!r||[`calculation`,`autoNumber`,`createdAt`,`updatedAt`].includes(r.type)||(ee[r.id]=u(e,r.type,r.options).value)}),d.set(n,{...l,updatedAt:new Date().toISOString(),values:ee})}),j=null,F=`Pasted ${l.length} row${l.length===1?``:`s`}${p?` (${p} new)`:``}.`,q({...i,records:f.map(e=>d.get(e)).filter(Boolean)})}var Sn=[{value:`contains`,label:`contains`,needsValue:!0,needsSecond:!1},{value:`equals`,label:`is exactly`,needsValue:!0,needsSecond:!1},{value:`startsWith`,label:`starts with`,needsValue:!0,needsSecond:!1},{value:`endsWith`,label:`ends with`,needsValue:!0,needsSecond:!1},{value:`greaterThan`,label:`greater than`,needsValue:!0,needsSecond:!1},{value:`lessThan`,label:`less than`,needsValue:!0,needsSecond:!1},{value:`between`,label:`between`,needsValue:!0,needsSecond:!0},{value:`isEmpty`,label:`is empty`,needsValue:!1,needsSecond:!1},{value:`isNotEmpty`,label:`is not empty`,needsValue:!1,needsSecond:!1}];function Cn(e){return U().fields.find(t=>t.id===e)?.name??`field`}function wn(e){return Sn.find(t=>t.value===e)?.label??e}function Tn(){let e=y.querySelector(`[data-find-match]`)?.value??`all`,t=[];y.querySelectorAll(`.find-rule`).forEach(e=>{let n=e.querySelector(`[data-find-field]`)?.value??``,r=e.querySelector(`[data-find-op]`)?.value??`contains`,i=e.querySelector(`[data-find-value]`)?.value??``,a=e.querySelector(`[data-find-value2]`)?.value??``;n&&t.push({fieldId:n,operator:r,value:i,value2:a})}),O={match:e,rules:t}}function En(){Tn(),D=O.rules.length?O:null,N=new Set,P=`none`;let e=W(U()).length;F=D?`Find is on: ${e} record${e===1?``:`s`} match.`:`Find cleared.`,Q()}function Dn(){let e=[];y.querySelectorAll(`.sort-level`).forEach(t=>{let n=t.querySelector(`[data-sort-level-field]`)?.value??``,r=t.querySelector(`[data-sort-level-dir]`)?.value??`asc`;n&&e.push({fieldId:n,direction:r})}),k=e}function On(){Dn(),E=k,P=`none`,F=E.length?`Sorting by ${E.map(e=>Cn(e.fieldId)).join(`, `)}.`:`Sort cleared.`,Q()}function kn(){return b.views??[]}function An(){let e=y.querySelector(`[data-view-name]`)?.value.trim()||`View ${kn().length+1}`,n={id:t(`view`),name:e,tableId:x,mode:C,search:w,searchFieldId:T,find:D,sortKeys:E};K(`save view`),F=`Saved view: ${e}.`,G({...b,updatedAt:new Date().toISOString(),views:[...kn(),n]})}function jn(e){let t=kn().find(t=>t.id===e);t&&(b.schema.tables.some(e=>e.id===t.tableId)&&(x=t.tableId,ct(U())),C=t.mode,w=t.search,T=t.searchFieldId,D=t.find,E=t.sortKeys,N=new Set,P=`none`,F=`Opened view: ${t.name}.`,Q())}function Mn(e){K(`delete view`),F=`Deleted a saved view.`,G({...b,updatedAt:new Date().toISOString(),views:kn().filter(t=>t.id!==e)})}function Nn(e){let t=new Set(e.records.map(e=>e.id));return[...A].filter(e=>t.has(e))}function Pn(){let e=U(),t=new Set(Nn(e));if(t.size===0)return;let n=e.records.filter(e=>!t.has(e.id));if(n.length===0){F=`Keep at least one record. Some rows were not deleted.`,Q();return}window.confirm(`Delete ${t.size} selected record${t.size===1?``:`s`}? You can undo right after.`)&&(K(`bulk delete`),A=new Set,F=`Deleted ${e.records.length-n.length} records.`,q({...e,records:n}))}function Fn(){let e=U(),t=Nn(e);if(t.length===0)return;K(`bulk duplicate`);let n=t.reduce((e,t)=>p(e,t),e);A=new Set,F=`Duplicated ${t.length} record${t.length===1?``:`s`}.`,q(n)}function In(){let e=U(),t=new Set(Nn(e)),n=y.querySelector(`[data-bulk-field]`)?.value??``,r=y.querySelector(`[data-bulk-value]`)?.value??``,i=e.fields.find(e=>e.id===n);if(!i||t.size===0){P=`none`,Q();return}let a=u(r,i.type,i.options).value;K(`bulk fill`);let o=e.records.map(e=>t.has(e.id)?{...e,updatedAt:new Date().toISOString(),values:{...e.values,[n]:a}}:e);P=`none`,F=`Filled ${i.name} for ${t.size} record${t.size===1?``:`s`}.`,q({...e,records:o})}function Ln(e){let t=e.filter(e=>e.trim()!==``);return t.length===0?`text`:t.every(e=>!Number.isNaN(Number(e.replace(/[$,%\s]/g,``))))?`number`:t.every(e=>!Number.isNaN(new Date(e).getTime())&&/\d/.test(e))?`date`:t.every(e=>/^(yes|no|true|false)$/i.test(e.trim()))?`checkbox`:`text`}function Rn(){y.querySelectorAll(`.csv-map-row`).forEach((e,t)=>{M[t]&&(M[t].action=e.querySelector(`[data-map-action]`)?.value??`new`,M[t].type=e.querySelector(`[data-map-type]`)?.value??`text`,M[t].fieldId=e.querySelector(`[data-map-existing]`)?.value??``)})}y.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-action]`)?.dataset.action,r=t.closest(`[data-table-id]`)?.dataset.tableId,i=t.closest(`[data-template-id]`)?.dataset.templateId,s=t.closest(`[data-view-mode]`)?.dataset.viewMode,c=t.closest(`[data-select-record]`)?.dataset.selectRecord,u=t.closest(`[data-field-settings]`)?.dataset.fieldSettings,d=t.closest(`[data-record-action-id]`)?.dataset.recordActionId,f=t.closest(`[data-quality-field-id]`);if(r){x=r,st(),E=[],A=new Set,j=null,ct(U()),Q();return}if(i){Ct(i);return}if(s){C=s,Q();return}if(c){S=c,C===`table`&&Q();return}if(u){Xe=u,Ye=``,P=`field`,Q();return}if(f){let e=f.dataset.qualityFieldId,t=f.dataset.qualityKind;if(e&&t){let n=t===`duplicates`?Pe(U(),e):Fe(U(),e);N=new Set(n.map(e=>e.id));let r=U().fields.find(t=>t.id===e);F=`Highlighted ${n.length} ${t===`duplicates`?`duplicate`:`missing`} record${n.length===1?``:`s`} in ${r?.name??`this field`}.`,P=`none`,Q();return}}if(n)if(mt(),n===`new`){if(!window.confirm(`Start a new database? Your current one is replaced here — export it first if you want to keep a copy. You can also undo right after.`))return;K(`new database`);let e=a(`Untitled Database`);x=e.schema.tables[0].id,S=e.schema.tables[0].records[0]?.id??``,N=new Set,G(e)}else if(n===`save-json`)gt();else if(n===`open-json`)y.querySelector(`[data-open-json]`)?.click();else if(n===`import-csv`)y.querySelector(`[data-import-csv]`)?.click();else if(n===`export-csv`)_t();else if(n===`export-report`)vt();else if(n===`project-packet`)yt();else if(n===`print`)window.print();else if(n===`add-record`)K(`add record`),q(l(U()));else if(n===`add-field`){let e=y.querySelector(`[data-new-field]`),t=y.querySelector(`[data-new-field-type]`)?.value;K(`add field`),q(o(U(),e?.value||`New Field`,t??`text`))}else if(n===`add-table`){let e=window.prompt(`New table name?`,`New Table`)??``;K(`add table`);let t=re(b,e);x=t.schema.tables.at(-1)?.id??x,S=U().records[0]?.id??``,G(t)}else if(n===`duplicate-record`&&d)K(`duplicate record`),q(p(U(),d));else if(n===`delete-record`&&d){if(U().records.length<=1){F=`Keep at least one record. Add another before deleting this one.`,Q();return}if(!window.confirm(`Delete this record? You can undo right after with Ctrl+Z.`))return;K(`delete record`),q(ee(U(),d))}else if(n===`toggle-sort`){if(E.length)E=[{...E[0],direction:E[0].direction===`asc`?`desc`:`asc`},...E.slice(1)];else{let e=U().fields[0];e&&(E=[{fieldId:e.id,direction:`asc`}])}Q()}else if(n===`sort`||n===`sort-dialog`)k=E.length?E.map(e=>({...e})):[{fieldId:U().fields[0]?.id??``,direction:`asc`}],P=`sort`,Q();else if(n===`find`)O=D?{match:D.match,rules:D.rules.map(e=>({...e}))}:{match:`all`,rules:[{fieldId:U().fields[0]?.id??``,operator:`contains`,value:``}]},P=`find`,Q();else if(n===`views`)P=`views`,Q();else if(n===`sort-add-level`)Dn(),k.push({fieldId:U().fields[0]?.id??``,direction:`asc`}),Q();else if(n===`sort-remove-level`){Dn();let e=Number(t.closest(`[data-level-index]`)?.dataset.levelIndex??`-1`);e>=0&&k.splice(e,1),Q()}else if(n===`apply-sort`)On();else if(n===`clear-sort`)Dn(),k=[],Q();else if(n===`find-add-rule`)Tn(),O.rules.push({fieldId:U().fields[0]?.id??``,operator:`contains`,value:``}),Q();else if(n===`find-remove-rule`){Tn();let e=Number(t.closest(`[data-rule-index]`)?.dataset.ruleIndex??`-1`);e>=0&&O.rules.splice(e,1),Q()}else if(n===`apply-find`)En();else if(n===`save-view`)An();else if(n===`apply-view`){let e=t.closest(`[data-view-id]`)?.dataset.viewId;e&&jn(e)}else if(n===`delete-view`){let e=t.closest(`[data-view-id]`)?.dataset.viewId;e&&Mn(e)}else if(n===`bulk-delete`)Pn();else if(n===`bulk-duplicate`)Fn();else if(n===`bulk-fill`)Nn(U()).length&&(P=`bulkFill`,Q());else if(n===`apply-bulk-fill`)In();else if(n===`bulk-clear`)A=new Set,Q();else if(n===`highlight-invalid`){let e=Ve(U());N=new Set(e.map(e=>e.record.id)),P=`none`,F=`Highlighted ${N.size} record${N.size===1?``:`s`} with rule problems.`,Q()}else if(n===`duplicates`){let e=T===`all`?U().fields[0]?.id:T;N=new Set(Pe(U(),e).map(e=>e.id)),F=`Found ${N.size} duplicate record${N.size===1?``:`s`}.`,Q()}else if(n===`missing`){let e=T===`all`?U().fields[0]?.id:T;N=new Set(Fe(U(),e).map(e=>e.id)),F=`Found ${N.size} record${N.size===1?``:`s`} with missing values.`,Q()}else if(n===`clear-find`)st(),F=`Showing all records.`,Q();else if(n===`replace`)R=[],P=`replace`,Q();else if(n===`preview-replace`)cn();else if(n===`run-replace`)sn();else if(n===`save-teacher-notes`)ln();else if(n===`apply-csv-new`)St(`new`);else if(n===`apply-csv-append`)St(`append`);else if(n===`save-field-settings`)K(`field settings`),on();else if(n===`layout-designer`||n===`lock-layout`)P=`layout`,Q();else if(n===`layout-field-up`||n===`layout-field-down`){let e=t.closest(`[data-layout-field-id]`)?.dataset.layoutFieldId,r=X();if(e&&r){let t=Dt(U()).map(e=>e.id),r=t.indexOf(e),i=n===`layout-field-up`?r-1:r+1;r>=0&&i>=0&&i<t.length&&([t[r],t[i]]=[t[i],t[r]],K(`layout order`),P=`layout`,Nt({fieldOrder:t}))}}else if(n===`save-layout-settings`){let e=y.querySelector(`[data-layout-locked]`)?.checked??!1,t=new Set([...y.querySelectorAll(`[data-layout-field-visible]:checked`)].map(e=>e.dataset.layoutFieldVisible??``)),n=Dt(U()).map(e=>e.id),r=n.filter(e=>!t.has(e));K(`layout settings`),P=`none`,Nt({locked:e,fieldOrder:n,hiddenFieldIds:r})}else n===`create-relationship`?dn():n===`undo-change`?ft():n===`redo-change`?pt():n===`close-dialog`?(P=`none`,R=[],z=null,Q()):n.endsWith(`-view`)?(C=n.replace(`-view`,``),Q()):n===`templates`?(F=`Template starters are in the Teacher panel.`,Q()):n===`student-view`?(K(`student view toggle`),F=b.teacher.studentView?`Teacher tools are visible again.`:`Student view is on.`,G({...b,updatedAt:new Date().toISOString(),teacher:{...b.teacher,studentView:!b.teacher.studentView}})):n===`project-ideas`?(P=`projectIdeas`,Q()):n===`relationships`?(P=`relationship`,Q()):n===`functions`?(P=`functions`,Q()):n===`quality`?(P=`quality`,Q()):n===`teacher-notes`?(P=`teacherNotes`,Q()):n.startsWith(`help-`)?(P=`help`,Q()):(F=`That ListSplatTM control is not available in this workspace.`,Q())}),y.addEventListener(`change`,e=>{let t=e.target;if(t.matches(`#languageSwitcher`)&&t instanceof HTMLSelectElement){B=nt(t.value);try{localStorage.setItem(We,B)}catch{}Q()}else if(t.matches(`[data-open-json]`)&&t instanceof HTMLInputElement&&t.files?.[0])bt(t.files[0]);else if(t.matches(`[data-import-csv]`)&&t instanceof HTMLInputElement&&t.files?.[0])xt(t.files[0]);else if(t.matches(`[data-search-field]`))T=t.value,N=new Set,Q();else if(t.matches(`[data-sort-field]`)){let e=E[0]?.direction??`asc`;E=t.value?[{fieldId:t.value,direction:e}]:[],Q()}else if(t.matches(`[data-select-all]`)&&t instanceof HTMLInputElement){let e=W(U()).map(e=>e.id);A=t.checked?new Set(e):new Set,Q()}else if(t.matches(`[data-select-row]`)&&t instanceof HTMLInputElement){let e=t.dataset.selectRow??``;t.checked?A.add(e):A.delete(e),Q()}else if(t.matches(`[data-field-type]`))Ye=t.value,Q();else if(t.matches(`[data-find-op]`))Tn(),Q();else if(t.matches(`[data-map-action]`))Rn(),Q();else if(t.matches(`[data-relationship-from-table], [data-relationship-to-table]`))fn();else if(t.matches(`.cell-input, .cell-checkbox, .image-input`)&&(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement))if(t instanceof HTMLInputElement&&t.type===`file`&&t.files?.[0]){let e=t.dataset.recordId,n=t.dataset.fieldId,r=t.files[0];e&&n&&an(e,n,r,`image upload`)}else t.dataset.recordId&&t.dataset.fieldId&&lt(t.dataset.recordId,t.dataset.fieldId),nn(t)}),y.addEventListener(`paste`,e=>{let t=e.target,n=t.closest(`.image-cell`);if(n){let t=n.dataset.recordId,r=n.dataset.fieldId,i=Array.from(e.clipboardData?.items??[]).find(e=>e.type.startsWith(`image/`))?.getAsFile();t&&r&&i&&(e.preventDefault(),an(t,r,i,`image paste`));return}let r=t.closest(`.cell-input`);if(!r||!r.closest(`.data-grid`)||!r.dataset.recordId||!r.dataset.fieldId)return;let i=e.clipboardData?.getData(`text/plain`)??``;/[\t\n]/.test(i.replace(/\n$/,``))&&(e.preventDefault(),xn(i,r.dataset.recordId,r.dataset.fieldId))}),y.addEventListener(`input`,e=>{let t=e.target;if(t.matches(`[data-project-title]`)){ht(t.value);return}if(t.matches(`[data-search]`)){w=t.value,N=new Set,Q();return}t.matches(`.cell-input`)&&(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement)&&(t.dataset.recordId&&t.dataset.fieldId&&lt(t.dataset.recordId,t.dataset.fieldId),nn(t))}),y.addEventListener(`focusout`,e=>{e.target.matches?.(`.cell-input, .cell-checkbox`)&&(Ze=``)}),y.addEventListener(`mousedown`,e=>{let t=e.target.closest(`[data-record-id][data-field-id]`);if(!t||!t.closest(`.data-grid`)||!t.dataset.recordId||!t.dataset.fieldId)return;let n={r:t.dataset.recordId,f:t.dataset.fieldId};e.shiftKey&&j?(e.preventDefault(),j={anchor:j.anchor,focus:n}):j={anchor:n,focus:n},vn()}),y.addEventListener(`pointerdown`,e=>{let t=e.target.closest(`[data-col-resize]`);if(!t)return;e.preventDefault(),e.stopPropagation();let n=t.dataset.colResize??``,r=t.closest(`th`);if(!r)return;r.setAttribute(`draggable`,`false`);let i=e.clientX,a=r.getBoundingClientRect().width,o=Math.round(a),s=e=>{o=Math.max(80,Math.round(a+(e.clientX-i))),r.style.width=`${o}px`,r.style.minWidth=`${o}px`},c=()=>{document.removeEventListener(`pointermove`,s),document.removeEventListener(`pointerup`,c),r.setAttribute(`draggable`,`true`);let e=X();e&&(K(`resize column`),Nt({columnWidths:{...e.columnWidths??{},[n]:o}}))};document.addEventListener(`pointermove`,s),document.addEventListener(`pointerup`,c)});var $=null;y.addEventListener(`dragstart`,e=>{let t=e.target;if(t.closest(`[data-col-resize]`))return;let n=t.closest(`.col-head[data-col-field]`);n&&($=n.dataset.colField??null,e.dataTransfer?.setData(`text/plain`,$??``))}),y.addEventListener(`dragover`,e=>{$&&e.target.closest(`.col-head[data-col-field]`)&&e.preventDefault()}),y.addEventListener(`drop`,e=>{let t=e.target.closest(`.col-head[data-col-field]`);if(!t||!$)return;e.preventDefault();let n=t.dataset.colField??``,r=$;if($=null,!n||n===r)return;let i=Dt(U()).map(e=>e.id),a=i.indexOf(r),o=i.indexOf(n);a<0||o<0||(i.splice(o,0,i.splice(a,1)[0]),K(`reorder columns`),Nt({fieldOrder:i}))}),y.addEventListener(`keydown`,e=>{let t=e.target;if(!t.matches?.(`.cell-input, .cell-checkbox`))return;let n=t.dataset.recordId,r=t.dataset.fieldId;if(!n||!r)return;let i=t instanceof HTMLTextAreaElement,a=t instanceof HTMLSelectElement;if(e.shiftKey&&[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`].includes(e.key)&&!i&&!a){j||={anchor:{r:n,f:r},focus:{r:n,f:r}},e.preventDefault(),yn(e.key);return}if(e.key===`Escape`&&j){j=null,vn();return}switch(e.key){case`Enter`:i||(e.preventDefault(),gn(n,r,e.shiftKey?-1:1,0));break;case`ArrowDown`:!i&&!a&&(e.preventDefault(),gn(n,r,1,0));break;case`ArrowUp`:!i&&!a&&(e.preventDefault(),gn(n,r,-1,0));break;case`Tab`:e.preventDefault(),gn(n,r,0,e.shiftKey?-1:1);break;default:break}}),document.addEventListener(`keydown`,e=>{if(!(e.ctrlKey||e.metaKey))return;let t=e.key.toLowerCase();if(t===`c`){bn()&&e.preventDefault();return}t===`z`&&!e.shiftKey?(e.preventDefault(),ft()):t===`y`||t===`z`&&e.shiftKey?(e.preventDefault(),pt()):t===`s`&&(e.preventDefault(),gt(),F=`Saved a .listsplat.json file to your downloads.`,Q())}),document.addEventListener(`click`,e=>{e.target.closest(`.menu`)||mt()}),document.addEventListener(`toggle`,e=>{let t=e.target;!(t instanceof HTMLDetailsElement)||!t.matches(`.menu`)||!t.open||document.querySelectorAll(`.menu[open]`).forEach(e=>{e!==t&&(e.open=!1)})},!0),Q();