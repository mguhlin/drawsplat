...
- **SplatWorksTM naming.** Standardized the Studio suite language around SplatWorksTM, WriteSplatTM, ListSplatTM, ShowSplatTM, and GridSplatTM in the public site and documentation.
