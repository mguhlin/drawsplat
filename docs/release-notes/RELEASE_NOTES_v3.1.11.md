...
- **DrawSplatTM tool grouping.** Big Link, Concept Map, Markdown Studio, Rubric Builder, ImageSplat™, and Word Search Maker sit under DrawSplatTM Tools rather than SplatWorksTM.
