...
These updates are live on drawsplat.org and in current source. Initially newer than the v3.1.25 downloads, they are now included in the September 24 v3.1.27 packages.
