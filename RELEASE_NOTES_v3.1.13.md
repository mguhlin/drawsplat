...
- **ShowSplatTM app scaffold.** Added `showsplat/`, a static browser app for building slide decks with a thumbnail rail, central 16:9 canvas, menus, icon toolbar, notes, templates, themes, object drag/resize, media insertion, Markdown Studio, slideshow preview, and WebDeck export.
