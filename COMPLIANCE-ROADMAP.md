...
|---|---|---|---|
| 0.1 | Compliance config schema (`compliance.config.json`) | [ ] | |
| 0.2 | Compliance UI scaffolding in Teacher Admin | [ ] | |
...
| 1.7 | Activity Records (audit log) &mdash; schema + write helpers | [ ] | |
| 1.8 | Activity Records &mdash; viewer UI in Teacher Admin | [ ] | |
...
| 2.3 | Parent Request Center &mdash; static page scaffold | [ ] | |
| 2.4 | Parent Request Center &mdash; Apps Script ticket endpoint | [ ] | |
...
| 3.6 | District Privacy Packet generator | [ ] | |
