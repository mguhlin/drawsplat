...
- **CipherSplat private encryption tool** at `solutions/CipherSplat/`. Encrypts files, recursive folders, and text locally with AES-256-GCM, authenticated chunked packages, and no upload or tracking path.
