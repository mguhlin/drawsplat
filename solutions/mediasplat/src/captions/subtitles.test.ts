...
import { subtitlesToAss } from "./subtitles";
it("neutralizes ASS override injection and preserves multiline cues", () => {
 const ass = subtitlesToAss("1\n00:00:01,000 --> 00:00:02,000\n{\\pos(0,0)}hello\nworld", defaultSubtitles);
 expect(ass).not.toContain("{\\pos"); expect(ass).toContain("hello\\Nworld"); expect(ass).toContain("0:00:01.00,0:00:02.00");
});
