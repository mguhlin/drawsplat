...
const en = {
  ...
  saveToDrive: "Save audio to Google Drive",
  createShareLink: "Create an Anyone-with-the-link URL and embed code",
  drivePrivacyNote: "Audio stays local until you choose Save. AudioSplat uploads only the exported mix to the Google Drive account you authorize.",
  workspaceSharingNote: "Your school or organization may prevent public link sharing. Saving can still succeed even when sharing is blocked.",
  driveNeedsAudio: "Record or import audio before saving to Google Drive.",
  uploadingToDrive: "Uploading to Google Drive…",
  driveSaveDone: "Saved to Google Drive",
  driveSaveFailed: "Google Drive could not save this audio. Confirm Drive access is allowed and try again.",
  googleUnavailable: "Google sign-in is still loading. Wait a moment, then try again.",
  driveAuthFailed: "Google authorization was cancelled or could not be completed.",
  sharingBlocked: "The audio was saved, but your Google Workspace sharing policy blocked a public link and embed code.",
  shareLink: "Share link",
  embedCode: "Embed code",
  copyLink: "Copy link",
  copyEmbed: "Copy embed code",
  openInDrive: "Open in Google Drive",
  privateDriveFile: "This file is private in your Google Drive. Use Drive sharing controls if you want to share it later.",
  copied: "Copied.",
  ...
  fitProject: "Fit project to window",
  dragToSelect: "Drag across the waveform to select audio",
  selectedRange: "Selected:",
  selectRangeFirst: "Drag across a waveform to select a range first.",
  deletedSelection: "selection deleted",
  selectionDeleted: "Selected audio deleted.",
  deleteSelectionFailed: "The selected audio could not be deleted.",
  record: "Record",
  pause: "Pause",
  resume: "Resume",
  stop: "Stop",
...
const dictionaries: Record<LanguageCode, Dictionary> = {
  ...
  es: {
    amplify: "Amplificar",
    zoomSelection: "Ampliar a la selección",
    fitProject: "Ajustar proyecto a la ventana",
    dragToSelect: "Arrastra sobre la onda para seleccionar audio",
    selectedRange: "Seleccionado:",
    selectRangeFirst: "Arrastra sobre una onda para seleccionar un intervalo.",
    deletedSelection: "selección eliminada",
    selectionDeleted: "Audio seleccionado eliminado.",
    deleteSelectionFailed: "No se pudo eliminar el audio seleccionado.",
  ...
  vi: {
    amplify: "Khuếch đại",
    zoomSelection: "Thu phóng vùng chọn",
    fitProject: "Vừa dự án với cửa sổ",
    dragToSelect: "Kéo trên dạng sóng để chọn âm thanh",
    selectedRange: "Đã chọn:",
    selectRangeFirst: "Hãy kéo trên dạng sóng để chọn một vùng.",
    deletedSelection: "đã xóa vùng chọn",
    selectionDeleted: "Đã xóa âm thanh được chọn.",
    deleteSelectionFailed: "Không thể xóa âm thanh được chọn.",
  ...
  ar: {
    amplify: "تضخيم",
    zoomSelection: "تكبير إلى التحديد",
    fitProject: "ملاءمة المشروع للنافذة",
    dragToSelect: "اسحب عبر الموجة لتحديد الصوت",
    selectedRange: "المحدد:",
    selectRangeFirst: "اسحب عبر الموجة لتحديد نطاق أولاً.",
    deletedSelection: "حُذف التحديد",
    selectionDeleted: "تم حذف الصوت المحدد.",
    deleteSelectionFailed: "تعذر حذف الصوت المحدد.",
  ...
  zh: {
    ...
    zoomSelection: "缩放到选区",
    fitProject: "项目适合窗口",
    dragToSelect: "在波形上拖动以选择音频",
    selectedRange: "已选择：",
    selectRangeFirst: "请先在波形上拖动选择范围。",
    deletedSelection: "选区已删除",
    selectionDeleted: "已删除所选音频。",
    deleteSelectionFailed: "无法删除所选音频。",
  ...
  uh: {
    ...
    zoomSelection: "चयन तक ज़ूम करें",
    fitProject: "प्रोजेक्ट को विंडो में समाएँ",
    dragToSelect: "ऑडियो चुनने के लिए वेवफ़ॉर्म पर खींचें",
    selectedRange: "चयनित:",
    selectRangeFirst: "पहले वेवफ़ॉर्म पर खींचकर सीमा चुनें।",
    deletedSelection: "चयन हटाया गया",
    selectionDeleted: "चयनित ऑडियो हटा दिया गया।",
    deleteSelectionFailed: "चयनित ऑडियो हटाया नहीं जा सका।",
