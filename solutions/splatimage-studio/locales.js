...
WidgetI18n.register('splatimage-studio', {
  en: {
    ...
    'effect.removeBg': 'Remove background color',
    'mask.circle': 'Circle',
    'mask.oval': 'Oval',
    ...
    'removeBg.help': "Pick the background color to make transparent. The starting color is sampled from the selected image's top-left corner.",
    'removeBg.color': 'Background color',
